...
Route::group(['prefix' => 'users','before' => 'csrf'], function () {
    ...
    Route::get('/createDepartmentRightsForm','UsersController@createDepartmentRightsForm');
...
Route::group(['prefix' => 'udc','before' => 'csrf'], function () {
    ...
    Route::get('/editMainMenuTitle', 'UsersDataCallController@editMainMenuTitle');
    Route::get('/editSubMenu', 'UsersDataCallController@editSubMenu');
});
...
Route::group(['prefix' => 'uad','before' => 'csrf'], function () {
    ...
    Route::post('/assignUserDepartmentRights','UsersAddDetailController@assignUserDepartmentRights');


     /*Edit Routes*/
     Route::post('/editMainMenuTitleDetail','UsersEditDetailController@editMainMenuTitleDetail');
