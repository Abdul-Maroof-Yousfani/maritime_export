                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <th class="text-center col-sm-1">Product Name</th>
                                            ...
                                            @foreach($type as $row)
                                                <tr id="{{ $row->type_id }}">
                                                    ...
                                                    <td class="text-center">
                                                        <button onclick="showDetailModelOneParamerter('<?= $paramOne ?>','<?= $row->type_id ?>','Edit Type List')" type="button" class="btn btn-success btn-sm">EDIT</button>
                                                        <button class="btn btn-sm btn-danger" onclick="delete_record('<?php echo $row->type_id; ?>')"> DELETE </button>
                                                    </td>
                                                </tr>
