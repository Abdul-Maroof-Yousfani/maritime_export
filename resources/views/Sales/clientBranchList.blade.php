                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <span class="subHeadingLabelClass">Client Branch List</span>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            $edit_url= url('/sales/editClientBranchForm/');
                                            ...
                                            @foreach($Branch as $row)
                                                <tr title="{{$row->id}}"  id="{{ $row->id }}">
                                                    ...
                                                    <td class="text-center">
                                                        <?php $CData = CommonHelper::get_single_row('client','id',$row->client_id);
                                                         if (!empty($CData->client_name)):
                                                            echo $CData->client_name;
                                                            else:
                                                            echo 'blank Value';
                                                            endif;
                                                      //   echo $row->client_id;
                                                    ...
                                                    <td class="text-center" style="width: 290px !important;">
                                                        ...
                                                        <span id="Created<?php echo $row->id?>">
                                                            <button disabled class="btn btn-xs btn-primary" onclick="addData('<?php echo $row->id; ?>')"> Create Account <span id="Loader<?php echo $row->id?>"></span></button>
                                                        </span>
                                                        <?php else:?>
