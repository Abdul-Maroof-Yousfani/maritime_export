			...
			<div class="bhoechie-tab-menu">
				<div class="list-group">
					...
					<div class="sub-menu collapse" id="MasterMenu">
                        <?php
                        $MasterMenuTitles = DB::table('main_menu_title')->select(['title','id','title_id'])->where('main_menu_id','=','Sales')->where('status','=','1')->where('menu_type','=','2')->get();
                        ?>
                    ...
                    <?php
                    $MainMenuTitles = DB::table('main_menu_title')->select(['title','id','title_id'])->where('main_menu_id','=','Sales')->where('status','=','1')->where('menu_type','=','1')->get();
                    ?>
