    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well">
                ...
                <div class="row">
                    <div class="row new">
                        <?php echo Form::open(array('url' => 'sad/updateImportDocument?m='.$m.'','id'=>'TestingForm','class'=>'stop'));?>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            ...
                                            <input type="text" class="form-control" id="voucher_no" name="voucher_no" readonly value="<?php echo $Master->voucher_no?>">
                                            <input type="hidden" class="form-control" id="edit_id" name="edit_id" readonly value="<?php echo $id?>">
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <select style="width: 100%" name="supplier_id" id="supplier_id" class="form-control select2 requiredField" required>
                                                ...
                                                <option value="<?php echo $Fil->id?>" <?php if($Master->vendor == $Fil->id): echo "selected"; endif;?> ><?php echo $Fil->name?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <label for="">Document No</label>
                                            <input type="text" name="document_number" id="document_number" class="form-control requiredField" value="<?php echo $Master->document_no?>">
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <label for="">Document Date</label>
                                            <input type="date" name="document_date" id="document_date" class="form-control" value="<?php echo $Master->document_date?>">
                                        </div>
                                    </div>
                                    <div class="lineHeight">&nbsp;</div>
                                            ...
                                            <div class="table-responsive" id="">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width: 130px;" class="text-center" >FCY Unit Price<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    ...
                                                    <?php
                                                            $Counter = 1;
                                                    foreach($Detail as $FilPiece):
                                                            if($FilPiece->type == 1):
                                                    $SubItem = CommonHelper::get_single_row('subitem','id',$FilPiece->item_id);
                                                    $ItemDetail = CommonHelper::get_data($FilPiece->item_id);
                                                    $ItemDetail = explode(',',$ItemDetail);
                                                    ?>
                                                    <tr class="RemoveRows<?php echo $Counter?>">
                                                        {{--<td class="text-center">< ?php echo $Counter;?></td>--}}
                                                        <td>
                                                            <input ondblclick="clear_fiel(this.id)"  onchange="get_detail(this.id,'<?php echo $Counter?>')" type="text" class="form-control sam_jass clear" name="sub_ic_des[]" id="item_<?php echo $Counter?>" value="<?php echo $SubItem->sub_ic?>">
                                                            <input type="hidden" class="requiredField clear" name="item_id[]" id="sub_<?php echo $Counter?>" value="<?php echo $FilPiece->item_id?>">
                                                        </td>
                                                        <td>
                                                            <input readonly type="text" class="form-control clear" name="uom_id[]" id="uom_id<?php echo $Counter?>" value="<?php echo $ItemDetail[0]?>">
                                                        </td>
                                                        <td>
                                                            <input onkeyup="Calc('{{$Counter}}')" onblur="Calc('{{$Counter}}')" type="number" class="form-control requiredField clear" name="system_qty[]" id="system_qty{{$Counter}}" placeholder="System Quantity" step="any" value="<?php echo $FilPiece->qty?>">
                                                        </td>
                                                        <td>
                                                            <input onkeyup="Calc('{{$Counter}}')" onblur="Calc('{{$Counter}}')" type="number" class="form-control requiredField clear" name="foreign_currency[]" id="foreign_currency{{$Counter}}" placeholder="Foreign Currency" step="any" value="<?php echo $FilPiece->foreign_currency_price?>">
                                                        </td>
                                                        <td>
                                                            <input readonly type="number" class="form-control clear piece_total" name="total_amount[]" id="total_amount{{$Counter}}" placeholder="Total Amount" step="any" value="<?php echo $FilPiece->amount?>">
                                                        </td>
                                                        <?php if($Counter > 1):?>
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-danger" id="BtnRemove<?php echo $Counter?>" onclick="RemoveSection('<?php echo $Counter?>')">&times;</button>
                                                        </td>
                                                        <?php else:?>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive" id="">
                                                <table class="table table-bordered">
                                                    ...
                                                    <?php
                                                    foreach($Detail as $FilWeight):
                                                    if($FilWeight->type== 2):
                                                    $SubItem = CommonHelper::get_single_row('subitem','id',$FilWeight->item_id);
                                                    $ItemDetail = CommonHelper::get_data($FilWeight->item_id);
                                                    $ItemDetail = explode(',',$ItemDetail);
                                                    ?>
                                                    <tr class="RemoveRows<?php echo $Counter?> remove">
                                                        {{--<td class="text-center AutoCounter">< ?php echo $Counter?></td>--}}
                                                        <td>
                                                            <input type="text" onchange="get_detail(this.id,'<?php echo $Counter?>')" class="form-control sam_jass" name="wsub_ic_des[]" id="item_<?php echo $Counter?>" value="<?php echo $SubItem->sub_ic?>">
                                                            <input type="hidden" class="requiredField" name="witem_id[]" id="sub_<?php echo $Counter?>" value="<?php echo $FilWeight->item_id?>">
                                                        </td>
                                                        <td>
                                                            <input readonly type="text" class="form-control" name="uom_id[]" id="uom_id<?php echo $Counter?>" value="<?php echo $ItemDetail[0]?>">
                                                        </td>
                                                        <td>
                                                            <input  onkeyup="calc_new('<?php echo $Counter?>')" type="number" class="form-control requiredField" name="wsystem_qty[]" id="system_qty<?php echo $Counter?>" placeholder="System Quantity" step="any" value="<?php echo $FilWeight->qty?>">
                                                        </td>

                                                        <td>
                                                            <input onkeyup="calc_new('<?php echo $Counter?>')" type="number" class="form-control requiredField" name="wtotal_weight[]" id="total_weight<?php echo $Counter?>" placeholder="" step="any" value="<?php echo $FilWeight->total_weight?>">
                                                        </td>

                                                        <td>
                                                            <input onkeyup="calc_new('<?php echo $Counter?>')" type="number" class="form-control requiredField" name="wtotal_rate_per_weight[]" id="total_rate_per_weight<?php echo $Counter?>" placeholder="" step="any" value="<?php echo $FilWeight->total_rate_per_weight?>">
                                                        </td>

                                                        <td>
                                                            <input onkeyup="" readonly type="number" class="form-control requiredField" name="was_per_weight[]" id="as_per_weight<?php echo $Counter?>" placeholder="" step="any" value="<?php echo $FilWeight->as_per_weight?>">
                                                            </td>
                                                        <td>
                                                            <input readonly onkeyup="Calc('<?php echo $Counter?>')" type="number" class="form-control requiredField" name="wforeign_currency[]" id="foreign_currency<?php echo $Counter?>" placeholder="Foreign Currency" step="any" value="<?php echo $FilWeight->foreign_currency_price?>">
                                                        </td>
                                                        <td>
                                                            <input readonly type="text" class="form-control total_weightt" name="wtotal_amount[]" id="total_amount<?php echo $Counter?>" placeholder="Total Amount" step="any" value="<?php echo $FilWeight->amount?>">
                                                        </td>
        ...
        <script>
            ...
            function add_more_by_weight()
            {
                ...
                $('#append_by_weight').append(
                        ...
                        '</td>' +
                        '<td>' +
                        '<input readonly onkeyup="Calc('+Counter+')" type="number" class="form-control requiredField" name="wforeign_currency[]" id="foreign_currency'+Counter+'" placeholder="Foreign Currency" step="any">' +
                        '</td>' +
                        '<td>' +
