                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <span class="subHeadingLabelClass">View Cash Sale Voucher List</span>
                                </div>
                            </div>
                            <div class="lineHeight">&nbsp;</div>
                            <input type="hidden" name="functionName" id="functionName" value="sdc/filterCashSaleVoucherList" readonly="readonly" class="form-control" />
                            <input type="hidden" name="tbodyId" id="tbodyId" value="filterCashSaleVoucherList" readonly="readonly" class="form-control" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <label>Cash Customers Name</label>
                                    ...
                                    <?php echo CommonHelper::cashCustomerSelectList($m);?>
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 text-right">
                                    <?php echo CommonHelper::displayPrintButtonInBlade('printCashSaleVoucherList','margin-top: 32px','1');?>
                            ...
                            <div class="lineHeight">&nbsp;</div>
                            <div id="printCashSaleVoucherList">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered sf-table-list">
                                                            ...
                                                            <tbody id="filterCashSaleVoucherList"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
                                    <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(200)->generate('Cash Sale Voucher List'))!!} ">
                                </div>
                            </div>
                            </div>
                        </div>
