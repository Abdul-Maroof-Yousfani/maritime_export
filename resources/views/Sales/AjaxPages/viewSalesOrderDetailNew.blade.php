                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div style="width:49%; float:left;">
                            <table  class="table " style="border: solid 1px black;">
                                ...
                                <tr>
                                    <td class="text-left" style="border:1px solid black;width:60%;">Buyer's Address</td>
                                    <td style="border:1px solid black;width:40%;" class="text-left"><?php echo  ucwords($customer_data->address);?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="text-left" style="border:1px solid black;">{{$sales_order->p_type == "local" ? 'Destination' : 'Port Of Discharge'}}</td>
                                    <td class="text-left" style="border:1px solid black;"><?php echo $sales_order->destination?></td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div style="width:50%; float:right;">
                            <table  class="table " style="border: solid 1px black;">
                                ...
                                <tr>
                                    <td class="text-left" style="border:1px solid black;width:60%;">{{$sales_order->p_type == "local" ? 'Terms Of Delivery' : 'Bill Of Landing'}}</td>
                                    <td class="text-left" style="border:1px solid black;width:40%;"><?php echo $sales_order->terms_of_delivery;?></td>
                                </tr>
                                <tr>
                                    <td class="text-left" style="border:1px solid black;">{{$sales_order->p_type == "local" ? 'Other Reference(S)' : 'Ship name / Voy'}}</td>
                                    <td class="text-left" style="border:1px solid black;"><?php echo $sales_order->other_refrence?></td>
                                </tr>
                                <tr>
                                    <td class="text-left" style="border:1px solid black;">{{$sales_order->p_type == "local" ? 'Despatch Through' : 'Port Of Landing'}}</td>
                                    <td class="text-left" style="border:1px solid black;"><?php echo $sales_order->desptch_through?></td>
                                </tr>
                        ...
                        <div class="table-responsive">
                            <table  id="tablee" class="table " style="border: solid 1px black;">
                                ...
                                <tbody>
                                    ...
                                    <td style="border:1px solid black;">{{  CommonHelper::get_fg_name($row->item_id) }}</td>    
                                    <td style="border:1px solid black;">{{ CommonHelper::get_fg_uom($row->item_id) }}</td>    
