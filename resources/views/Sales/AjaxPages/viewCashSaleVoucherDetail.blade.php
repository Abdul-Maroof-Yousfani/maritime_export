...
<div class="row" id="printCashSaleVoucherDetail">
                    ...
                    <div class="table-responsive">
                        <table  class="table table-bordered table-striped table-condensed tableMargin">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo number_format($row1->price);?></td>
                                <td class="text-center"><?php echo $row1->qty;?></td>
                                <td class="text-center"><?php echo number_format($row1->amount);?></td>
                            </tr>
                            <?php
                            }
                            ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(200)->generate('View Cash Sale Voucher Detail'))!!} ">
    </div>
    <?php }?>
</div>
<script>
