                        ...
                        ">
                            ...
                            <div style="width:40%; float:right;">
                                <table  style="border:1px solid black;" class="table  sales_Tax_Invoice_data">
                                    ...
                                    @if($sales_tax_invoice->so_id != 0):
                                    <tr>
                                        <th style="border:1px solid black;" class="text-left" style="width:50%; border: solid 1px;">Other Reference</th>
                                ...
                                <table style="border:1px solid black;"  class="table  sales_Tax_Invoice_data">
                                    ...
                                    @if ($bundle_stop==1)
                                        <tr  style="font-size: larger;font-weight: bold;background-color: lightyellow" class="ShowHideHtml">
                                            ...
                                            <td style="border:1px solid black;" class="text-right hidee"><?php echo number_format($row1->bqty*$row1->bundle_rate,2);?></td>
