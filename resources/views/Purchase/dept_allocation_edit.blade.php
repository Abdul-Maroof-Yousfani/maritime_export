...
<?php
$data= CommonHelper::department_allocation_data($purchase_data->id,$type);

?>
<div id="dept_allocation1"  style=""  class="col-lg-4 col-md-4 col-sm-4 col-xs-12 banks removeDemandsRows_dept_1_<?php echo  $count1 ?>">

    <div class="row">
        <div id="dept_allocation1"  class="col-lg-5 col-md-5 col-sm-5 col-xs-5 banks">
            <input  @if (empty($data)) checked @endif type="checkbox" name="dept_check_box<?php echo  $count1 ?>" value="1" id="dept_check_box<?php echo  $count1 ?>" class="">Allow Null</label>
        </div>
    ...
    <table  id="table1" class="table table-bordered">
        <input type="hidden" name="dept_hidden_amount<?php echo $count1 ?>" id="dept_hidden_amount<?php echo $count1 ?>" value="{{$purchase_data->amount}}"/>
        ...
        @foreach(CommonHelper::department_allocation_data($purchase_data->id,$type) as $row1)
        ...
        <tr>
            ...
            <td class="text-right">
                ...
                <input value="{{$row1->amount}}" onblur="add('<?php echo $count1 ?>',this.id)"   onkeyup="calculation_dept_item_amount(this.id,'<?php echo $count1 ?>')" class="department_amount<?php echo  $count1 ?> form-control dept1" style="text-align: right" type="text" name="department_amount<?php echo  $count1 ?>[]" id="department_amount_<?php echo $count1 ?>_<?php echo  $department_allocation ?>" />
            </td><!-->
        </tr>
...
@endif
        ...
        <tr>
            ...
            <td colspan="2" ><input value="{{$total_amount}}" style="text-align: right;" readonly type="text" class="form-control" name="total_dept<?php echo $count1 ?>" id="total_dept<?php echo $count1 ?>"></td>
        </tr>
    </table>
</div>
...
<script type="text/javascript">
   ...
   var  dept_allocation=0;

    $(document).ready(function() {
         dept_allocation='<?php echo $department_allocation ?>';
