<div id="sales_tax1" style="display: none;" class="col-lg-4 col-md-4 col-sm-4 col-xs-12 banks">



    <div class="row">
        <div id="dept_allocation1"  class="col-lg-5 col-md-5 col-sm-5 col-xs-5 banks">
            <input type="checkbox" name="sales_tax_check_box1" value="1" id="sales_tax_check_box1" class="">Allow Null</label>
        </div>
    ...
    <table   id="sales_tax_table1" class="table table-bordered">
        ...
        <tr>
            <td style="width: 40%">
                <select onchange="open_form(this.id)" style="width: 180px"  name="sales_tax_department1[]" id="sales_tax_department_1_1"
            ...
            <td>
                <input placeholder="Percentage" onkeyup="sales_tax_calculation_dept_item(this.id,1)" type="any" name="sales_tax_percent1[]" id="sales_tax_percent_1_1" class="form-control" />
            </td>
            <td class="text-right">

                <input onblur="add_sales_tax('1',this.id)" onkeyup="sales_tax_calculation_dept_item_amount(this.id,1)" class="sales_tax_department_amount1 form-control" style="text-align: right" type="text" name="sales_tax_department_amount1[]" id="sales_tax_department_amount_1_1" class="form-control" />
            </td><!-->
        </tr>
        ...
        <tr>
            ...
            <td colspan="2"><input style="text-align: right;" readonly type="text" class="form-control" name="sales_tax_total_dept1" id="sales_tax_total_dept1"></td>
        </tr>
    </table>
</div>
<!--
