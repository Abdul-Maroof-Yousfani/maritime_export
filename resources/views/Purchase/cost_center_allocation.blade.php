...
<div id="cost_center1"  style="display: none;" class="col-lg-4 col-md-4 col-sm-4 col-xs-12 banks">

    <div class="row">
        <div id="dept_allocation1"  class="col-lg-5 col-md-5 col-sm-5 col-xs-6 banks">
            <input type="checkbox" name="cost_center_check_box1" value="1" id="cost_center_check_box1" class="">Allow Null  </label>
        </div>
    ...
    <table  id="cost_center_table1" class="table table-bordered">
        ...
        <tr>
            <td style="width: 40%">
                <select style="width: 180px;" onchange="open_form_cost_center(this.id);check_repeatition(this.id,'1')"  name="cost_center_department1[]" id="cost_center_department_1_1"
                        class="form-control select2 CostCenter cost_allocation1">
            ...
            <td>
                <input onkeyup="cost_center_calculation_dept_item(this.id,1)" placeholder="Percentage" type="any" name="cost_center_percent1[]" id="cost_center_percent_1_1" class="form-control" />
            </td>
            <td class="text-right">

                <input onblur="add_cost_center('1',this.id)"  onkeyup="cost_center_calculation_dept_item_amount(this.id,1);addclass(this.id,'1_1')" class="cost_center_department_amount1 form-control" style="text-align: right" type="text" name="cost_center_department_amount1[]" id="cost_center_department_amount_1_1" class="form-control" />
            </td><!-->
        </tr>
        ...
        <tr>
            ...
            <td   style="text-align: right" id="cost_center_dept_amount1">0</td>
            <td colspan="1"><input style="text-align: right;font-size: 12px" readonly type="text" class="form-control" name="cost_center_total_dept1" id="cost_center_total_dept1"></td>
        </tr>
    </table>
</div>
<!--
