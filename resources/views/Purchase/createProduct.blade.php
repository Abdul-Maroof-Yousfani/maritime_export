...
@section('content')
       ...
       / include('Purchase.'.$accType.'purchaseMenu')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well">
                ...
                <div class="row">
                    <?php echo Form::open(array('url' => 'pad/addProduct','id'=>'cashPaymentVoucherForm'));?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <select class="form-control requiredField select2" name="acc_id" id="acc_id">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <input autofocus type="text" class="form-control requiredField" placeholder="Product Name" name="product_name" id="product_name" value="" onkeypress="ReplaceSingleQoutes()" onkeyup="ReplaceSingleQoutes()" />
                                            </div>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <select class="form-control requiredField select2" name="type_id" id="type_id">
                                                    ...
                                                    @foreach(CommonHelper::get_all_product_type() as $row)
                                                        <option value="{{$row->product_type_id}}">{{$row->type}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
    ...
    <script>
        function ReplaceSingleQoutes()
        {
            var ProductName = $('#product_name').val();
            ProductName = ProductName.replace(/'/g, '"');
            ProductName = $('#product_name').val(ProductName);
