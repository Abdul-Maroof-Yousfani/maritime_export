       ...
       / include('Purchase.'.$accType.'purchaseMenu')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well">
                ...
                <div class="row">
                    <?php echo Form::open(array('url' => 'pad/createPurchaseVoucher','id'=>'cashPaymentVoucherForm'));?>
                                        ...
                                        <div class="row">
                                            ...
                                            $pv_no = 'pv'.($str+1); ?>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <label class="sf-label">Advance Payment No <span class="rflabelsteric"><strong>*</strong></span></label>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select name="curren" id="curren" class="form-control select2 requiredField">
                                                    ...
                                                    @foreach(CommonHelper::get_all_currency() as $row)
                                                        <option value="{{$row->id.','.$row->rate}}">{{$row->curreny.'------'.$row->rate}}</option>
                                                    @endforeach;
                                            ...
                                            <div  class="addMoreDemandsDetailRows_1" id="addMoreDemandsDetailRows_1">
                                                <table  id="" class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width: 200px;" class="text-center hidden-print"><a tabindex="-1"  href="#" onclick="showDetailModelOneParamerter('fdc/createAccountFormAjax/category_id_1_1')" class="">Acc. Head</a>
                                                            <strong>*</strong></span>
                                                        </th>
                                                        ...
                                                        <th style="width: 200px;" class="text-center hidden-print"><a tabindex="-1"  href="#" onclick="showDetailModelOneParamerter('fdc/createAccountFormAjax/accounts_1_1')" class="">Sales Tax Acc</a>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <!--
                                                                <select style="width: 100%" name="category_id_1_1" id="category_id_1_1" onchange="subItemListLoadDepandentCategoryId(this.id,this.value)" class="form-control requiredField select2">
                                                                    <?php echo PurchaseHelper::categoryList($_GET['m'],'0');?>
                                                                                            ...
                                                                                            -->
                                                            <select  style="width: 200px;font-size: 10px;" class="form-control requiredField select2"  id="category_id_1_1" class="form-control requiredField" name="category_id_1_1" onchange="">
                                                        ...
                                                        <td>
                                                            <input onkeyup="calculation_amount(this.id)"  type="number" step="0.01" name="qty_1_1" id="qty_1_1" class="form-control qty" />
                                                        </td>

                                                        <td>
                                                            <input  onkeyup="calculation_amount(this.id)" type="number" step="0.01" name="rate_1_1" id="rate_1_1" class="form-control rate" />
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="hidden" step="0.01" name="amount_1_1" id="amount_1_1"/>
                                                        </td>


                                                        <td>
                                                            <select   onchange="sales_tax(this.id)" style="width: 200px;" name="accounts_1_1" id="accounts_1_1"
                                                                      class="form-control sales_tax select2">
                                                                <option value="0">Select</option>
                                                                @foreach(FinanceHelper::get_accounts() as $row)
                                                                    <?php $code=explode('-',$row->code); ?>
                                                                    <option value="{{$row->id}}">{{$code[0].'--'.ucwords($row->name)}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <!--
                                                                                                                        ...
                                                                                                                        <!--->
                                                        <td>
                                                            <input onkeyup="pick_amount(this.id,'sales_tax_amount_1_1');tax_by_amount(this.id)"    type="text" name="sales_tax_amounttd_1_1" id="sales_tax_amounttd_1_1" class="form-control requiredField sales_tax_amount" />
                                                            <input type="hidden" name="sales_tax_amount_1_1" id="sales_tax_amount_1_1" />
                                                        </td>
                                                        <td>
                                                            <input readonly type="text" name="net_amounttd_1_1" id="net_amounttd_1_1" class="form-control requiredField" />
                                                            <input class="net_amount" type="hidden" name="net_amount_1_1" id="net_amount_1_1" />
                                                   ...
                                                   <tr>
                                                       <td>
                                                       <select class="form-control" id="txt_nature_1_1" name="txt_nature_1_1">
                                                           <option value="0">Select Sales Tax Nature</option>
                                                       ...
                                                       <td>
                                                           <select class="form-control" name="income_txt_nature_1_1" id="income_txt_nature_1_1">
                                                               <option value="0">Select Income Tax Nature</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    @include('Purchase.dept_allocation')



                                                    @include('Purchase.cost_center_allocation')



                                                    @include('Purchase.sales_tax_allocation')
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#sales_tax_amounttd_1_1').number(true,2);
                $('#amounttd_1_1').number(true,2);
                $('#net_amounttd_1_1').number(true,2);
