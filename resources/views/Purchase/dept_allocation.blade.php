...
<div id="dept_allocation1"  style="display: none"  class="col-lg-4 col-md-4 col-sm-4 col-xs-12 banks">

    <div class="row">
        <div id="dept_allocation1"  class="col-lg-5 col-md-5 col-sm-5 col-xs-5 banks">
            <input type="checkbox" name="dept_check_box1" value="1" id="dept_check_box1" class="">Allow Null</label>
        </div>
    ...
    <table  id="table1" class="table table-bordered">
        ...
        <tr>
            <td style="width: 40%">
                <select  onchange="open_form(this.id)" style="width: 190px" name="department1[]" id="department_1_1"
            ...
            <td>
                <input  onkeyup="calculation_dept_item(this.id,1)" placeholder="Percentage" type="any" name="percent1[]" id="percent_1_1" class="form-control dept1" />
            </td>
            <td class="text-right">

                <input onblur="add('1',this.id)"   onkeyup="calculation_dept_item_amount(this.id,1)" class="department_amount1 form-control dept1" style="text-align: right" type="text" name="department_amount1[]" id="department_amount_1_1" />
            </td><!-->
        </tr>
        ...
        <tr>
            ...
            <td colspan="1"  style="text-align: right" id="dep_allocation_remainig_amount1">0</td>
            <td colspan="1" ><input style="text-align: right;" readonly type="text" class="form-control" name="total_dept1" id="total_dept1"></td>
        </tr>
    </table>
</div>
...
<script type="text/javascript">
    ...
    function heading_change(number)
    {
        ...
        $('#dep_allocation_remainig_amount'+number).text(total);
