...
@section('content')
    ...
    <script !src="">
        ...
        function IssuanceType(Type)
        {
            ...
            {
                $('#ShowHideAll').css('display','block');
                $('.DeliveryChallan').css('display','block');
                $('#IssueWithJobOrder1').css('display','none');
                $('#IssueWithJobOrder2').css('display','none');
                $('#region').removeClass('requiredField');
                $('#joborder').removeClass('requiredField');
                $('#region_to').addClass('requiredField');
                $('input[name="IssuanceType"]').val(Type);
                $("#IssType").val(Type);
            }
            else if(Type==3)
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <span class="subHeadingLabelClass">Edit Good Issuance Form</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <select name="IssType" id="IssType" class="form-control" onchange="IssuanceType(this.value);">
                            ...
                            <option value="5">Damage Delivery Challan Issuance</option>
                        </select>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <input readonly type="text" class="form-control requiredField" placeholder="" name="is_no" id="is_no" value="{{ $Issuance->iss_no }}" />
                                            </div>

                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <label class="sf-label">ISSUANCE Date.</label>
                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                <input type="date" class="form-control requiredField" max="<?php echo date('Y-m-d') ?>" name="iss_date_1" id="iss_date_1" value="<?php echo $Issuance->iss_date ?>" />
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 DeliveryChallan">
                                                <label class="sf-label">Region To</label>
                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                <select class="form-control requiredField select2" name="region_to" id="region_to">
                                                    <option value="">Select Region</option>
                                                    @foreach(CommonHelper::get_all_regions() as $row)
                                                        <option value="{{$row->id}}" <?php if($Issuance->region_to == $row->id){echo "selected";}?> >{{$row->region_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
