                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="row">
                                                            @php
                                                            $vendor_code = App\Helpers\CommonHelper::get_vendor_code();   
                                                            @endphp
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                            <label>Vendor Code :</label>
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input readonly name="vendor_code" value="{{$vendor_code}}" id="vendor_code" type="text" class="form-control requiredField">
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input autofocus type="text" name="company_name" id="company_name" value="" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
