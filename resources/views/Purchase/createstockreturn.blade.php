        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well">
                ...
                <div class="row" id="ShowHideAll">
                    <?php echo Form::open(array('url' => 'pad/addStockReturnDetail?m='.$m.'','id'=>'cashPaymentVoucherForm'));?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <input type="date" class="form-control requiredField" max="<?php echo date('Y-m-d') ?>" name="iss_date_1" id="iss_date_1" value="<?php echo date('Y-m-d') ?>" />
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="IssueWithJobOrder2">
                                                ...
                                                <select  name="joborder" id="joborder" class="form-control requiredField select2">
                                                    ...
                                                    <?php foreach($issuanceJoborder as $val):  ?>
                                                        <option value="<?= $val->joborder ?>"> <?= $val->joborder ?> </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="table-responsive">
                                            <table id="buildyourform" class="table table-bordered">
                                                ...
                                                <input type="hidden" name="issuanceDataSection_1[]" class="form-control requiredField" id="issuanceDataSection_1" value="1" />
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <select onchange="get_detail(this.id,1)"  name="sub_item_id_1_1" id="sub_item_id_1_1" class="form-control requiredField select2">
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input onkeyup="CurrentQty(this.id,1)" step="0.01" type="number" name="qty_1_1" id="qty_1_1" class="form-control requiredField" />
                                                    </td>
                                                    <td><input class="form-control" readonly type="text" id="stock_qty_1_1" name="stock_qty_1_1"/> </td>
                                                    <td class="text-right"><input class="form-control" readonly type="text" id="current_qty_1_1" name="current_qty_1_1"/> </td>
