<div id="sales_taxs<?php echo $sales_tax_count ?>" style="display: none;" class="col-lg-6 col-md-6 col-sm-6 col-xs-12 banks">

    <?php  ?>

    <div class="row">
        <div id="dept_allocation<?php echo $sales_tax_count ?>"  class="col-lg-5 col-md-5 col-sm-5 col-xs-5 banks">
            <input type="checkbox" checked name="sales_tax_check_box<?php echo $sales_tax_count ?>" value="1" id="sales_tax_check_box<?php echo $sales_tax_count ?>" class="">Allow Null</label>
        </div>
    ...
    <input type="hidden" value="{{$sales_tax_amount}}" name="sales_tax_dept_hidden_amount<?php echo $sales_tax_count ?>" id="sales_tax_dept_hidden_amount<?php echo $sales_tax_count ?>"/>

    <table   id="sales_tax_table<?php echo $sales_tax_count ?>" class="table table-bordered">

        <tbody class="sales_tax_addrows<?php echo $sales_tax_count ?>" id="">
        <input type="hidden" name="" class="form-control requiredField" id="" value="1" />
        <tr>
            <td style="width: 40%">
                <select onchange="open_form(this.id)" style="width: 100%"  name="sales_tax_department<?php echo $sales_tax_count ?>[]" id="sales_tax_department_<?php echo $sales_tax_count ?>_1"
            ...
            <td>
                <input placeholder="Percentage" onkeyup="sales_tax_calculation_dept_item(this.id,'<?php echo $sales_tax_count ?>')" type="any" name="sales_tax_percent<?php echo $sales_tax_count ?>[]" id="sales_tax_percent_<?php echo $sales_tax_count ?>_1" class="form-control" />
            </td>
            <td class="text-right">

                <input onblur="add_sales_tax('<?php echo $sales_tax_count ?>',this.id)" onkeyup="sales_tax_calculation_dept_item_amount(this.id,'<?php echo $sales_tax_count ?>')" class="sales_tax_department_amount<?php echo $sales_tax_count ?> form-control"
                       style="text-align: right" type="text" name="sales_tax_department_amount<?php echo $sales_tax_count ?>[]" id="sales_tax_department_amount_<?php echo $sales_tax_count ?>_1" class="form-control" />
            </td><!-->
        </tr>
        ...
        <tr>
            ...
            <td colspan="2"><input style="text-align: right;" readonly type="text" class="form-control" name="sales_tax_total_dept<?php echo $sales_tax_count ?>" id="sales_tax_total_dept<?php echo $sales_tax_count ?>"></td>
        </tr>
    </table>
</div>
<!--
...
<script>
    ...
    function sales_tax_AddMore(number)
    {
        ...
        $(wrapper).append('<tr><td style="40%"><select onchange="open_form(this.id)" style="width: 100%;" name="sales_tax_department'+number+'[]" id="sales_tax_department_'+number+'_'+dept_allocation+'" class="form-control select2 dept_form">' +
