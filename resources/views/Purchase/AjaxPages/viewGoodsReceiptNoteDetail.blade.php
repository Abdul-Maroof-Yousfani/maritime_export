...
$goodsReceiptNoteDetail = GoodsReceiptNote::where('grn_no','=',$id)->where('status',1)->get();
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        @if ($approve == true)
            @if ($grn_status == 1)
                <button onclick="approve_grn({{ $row->id }}); btnDis()" id="BtnApproved" type="button"
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        ...
        <div style="line-height:5px;">&nbsp;</div>
        <?php }?>
        <?php echo Form::open(['url' => 'pad/createStoreChallanandApproveGoodsReceiptNote?m=' . $m . '', 'id' => 'createStoreChallanandApproveGoodsReceiptNote']); ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="printGoodsReceiptNoteVoucherDetail">
            <div class="well">
                <div class="row">
                    ...
                    <div style="line-height:5px;">&nbsp;</div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0 35px">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table class="table table-bordered table-striped table-condensed tableMargin">
                                            <tbody>
                                                ...
                                                <?php if($row->type != 5):
                                                    ...
                                                    $paramTwo = App\Models\PurchaseRequest::where('purchase_request_no', $row->po_no)->first()->id;
                                                    $paramThree = "View Purchase Order Detail";
                                                ?>
                                                <tr>
                                                    <td style="width:40%;">PO No.</td>
                                                    <td style="width:60%;"><?php echo '<button onclick="showDetailModelOneParamerter(\''.$paramOne.'\',\''.$paramTwo.'\',\''.$paramThree.'\')" type="button" class="btn btn-link btn-xs">'.strtoupper($row->po_no).'</button>'; ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if ($row->type == 0):
                                                        echo CommonHelper::changeDateFormat($row->po_date);
                                                    endif; ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Bill Date</td>
                                                    ...
                                                    <tr class="hidden-print">
                                                        ...
                                                        <td>
                                                            @foreach ($row->attachments as $attachment)
                                                                @php  $encodedFilePath = implode('/', array_map('rawurlencode', explode('/',str_replace('#', '',  $attachment->image_src)))); 
                                                                        
                                                                @endphp
                                                                <a href="{{ asset($encodedFilePath) }}"
                                                                    target="blank"
                                    ...
                                    <div style="width:40%; float:right;">
                                        <table class="table table-bordered table-striped table-condensed tableMargin">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Document Mode</td>
                                                    <td width=""><?php echo CommonHelper::mode_type()[$row->p_type]; ?></td>
                                                </tr>
                                            </tbody>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-condensed tableMargin">
                                            ...
                                            <tbody>
                                                <?php
                                    CommonHelper::companyDatabaseConnection($m);
                                    $grnDataDetail = DB::table('grn_data')->where('grn_no','=',$id)->where('sttaus',1)->get();
                                    ...
                                    ?>
                                            ...
                                            ?>
                                                        <a class="LinkHide"
                                                            href="<?php echo url('/'); ?>/store/fullstockReportView?pageType=&&parentCode=97&&m=<?php echo Session::get('run_company'); ?>&&sub_item_id=<?php echo $row1->sub_item_id; ?>&&warehouse_id=<?php echo $row1->warehouse_id; ?>#SFR"
                                                            target="_blank">
                                                            <?php
                                                            if ($row1->description != ''):
                                    ...
                                    ?>
                                            ...
                                            <tr class="text-center" style="background-color: darkgrey">
                                                ...
                                                <td style="font-size: larger;font-weight: bold"><?php echo number_format($total_import_qty, 2); ?>
                                                </td>
                                                <td></td>
                                                <td style="font-size: larger;font-weight: bold"><?php echo number_format($total_import_amount, 2); ?>
                                                </td>
                                                <td></td>
                                            </tr>
                                        </table>
                                        <div>
                                            ...
                                            $bank_payment = DB::Connection('mysql2')
                                                ->table('import_payment')
                                                ->where('import_id', $row->import_id)
                                                ->sum('amount_in_pkr');
                                            
                                            $expense_data = DB::Connection('mysql2')
                                                ->table('import_expense')
                                                ->where('import_id', $row->import_id);
                                            $total_exp = $expense_data->sum('duty') + $expense_data->sum('eto') + $expense_data->sum('do') + $expense_data->sum('appraisal') + $expense_data->sum('fright') + $expense_data->sum('insurance') + $expense_data->sum('expense') + $expense_data->sum('other_expense');
                                            ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 printHide">
                                    <BUTTon type="button" onclick="removeHideFromRow()">Show All</BUTTon>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 printHide text-right">
                                    <a class="btn btn-xs btn-warning" href="{{url('store/printGrnItemBarcode/'.$row->id)}}" target="blank">Print Barcode</a>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-condensed tableMargin">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Ordered Qty <span
                                                            class="rflabelsteric"></span></th>
                                                    <th class="text-center">Received Qty<span
                                                            class="rflabelsteric"></span></th>
                                                    <th class="ShowHideRate text-center" style="display: none;"> Rate
                                                    </th>
                                                    <th class="ShowHideAmount text-center" style="display: none;">
                                                        Amount</th>
                                                    <th class="ShowHideDiscountPercent text-center"
                                                        style="display: none;"> Discount %</th>
                                                    <th class="ShowHideDiscountAmount text-center"
                                                        style="display: none;"> Discount Amount</th>
                                                    <th class="ShowHideNetAmount text-center" style="display: none;">
                                                        Net Amount</th>
                                                    <th class="text-center">Reject. QTY</th>
                                                    <th class="text-center">BAL. QTY. Receivable</th>
                                                    <th class="text-center">Location</th>
                                                    <th class="text-center">Received Type</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    CommonHelper::companyDatabaseConnection($m);
                                                    $grnDataDetail = DB::table('grn_data')->where('grn_no','=',$id)
                                                    // ->where('purchase_recived_qty','!=',0)
                                                    ->get();
                                                    ...
                                                    $purchaseRequestData = PurchaseRequestData::find($row1->po_data_id);
                                                    // dd($purchaseRequestData);
                                                ?>
                                                <tr class="@if ($row1->purchase_recived_qty - $row1->qc_qty == 0) hidden-print @endif @if ($row1->purchase_recived_qty == 0) hide removeHide @endif" >

                                                    <td>
                                                        @if ($row1->bal_reciable > 0 && $purchaseRequestData->purchase_request_status != 3 )
                                                            <input type="checkbox" name='grnForComplete' class="printHide" value="{{ $row1->id }}">
                                                        @endif
                                                        {{ ' ' . $counter }}
                                                    </td>

                                                    <td title="{{ $sub_ic_detail[10].' - '.$item_name }}" class="text-center">
                                                        {{ $sub_ic_detail[10].' - '.$item_name }}
                                                    </td>
                                                    <td class="text-center"><?php echo $sub_ic_detail[0]; ?></td>
                                                    <td class="text-center"><?php echo $purchaseRequestData->demand_no; ?></td>
                                                    <input type="hidden" name="demand_no" id="demand_no" value="{{strtoupper($purchaseRequestData->demand_no)}}">
                                                    <td class="text-center"><?php echo $row1->batch_code; ?></td>
                                                    <td class="text-center"><?php echo $row1->expiry_date ? CommonHelper::changeDateFormat($row1->expiry_date) : '-'; ?></td>
                                                    ...
                                                    <td class="text-center ShowHideRate" style="display: none;">
                                                        <?php echo number_format($row1->rate, 2); ?></td>
                                                    <td class="text-center ShowHideAmount" style="display: none;">
                                                        <?php echo number_format($row1->amount, 2); ?></td>
                                                    <td class="text-center ShowHideDiscountPercent"
                                                        style="display: none;"><?php echo number_format($row1->discount_percent, 2); ?></td>
                                                    <td class="text-center ShowHideDiscountAmount"
                                                        style="display: none;"><?php echo number_format($row1->discount_amount, 2); ?></td>
                                                    <td class="text-center ShowHideNetAmount" style="display: none;">
                                                        <?php echo number_format($row1->net_amount, 2); ?></td>
                                                    <td class="text-center"><?php echo number_format($row1->reject_qty, 2); ?></td>
                                                    <td @if ($row->type == 0) @if ($row1->purchase_recived_qty > $row1->purchase_approved_qty)style="background-color: yellow" @endif
                                                        @endif
                                                        class="text-center"><?php echo number_format($row1->bal_reciable, 2); ?></td>
                                                    <td class="text-center">
                                                        <?php $Warehouse = CommonHelper::get_single_row('warehouse', 'id', $row1->warehouse_id);
                                                         if($Warehouse){
                                                            echo $Warehouse->name;
                                                    ...
                                                    <td class="text-center"><?php echo $row1->received_type; ?></td>
                                                </tr>
                                                <?php  $counter++; } ?>
                                            </tbody>
                                        </table>
                                        <button type="button" class="btn btn-primary printHide" onclick="completeAndMakePR()">Complete And Make PR</button>
                                        <br>
                                        <table style="display: none;" id=""
                                            class="table table-bordered tra">
                                            <tr class="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="debit_amount text-right">
                                                        @if ($row1->debit_credit == 1)
                                                            {{ number_format($row1->amount, 2) }} @php $total_debit+=$row1->amount  @endphp
                                                        @endif
                                                    </td>
                                                    <td class="debit_amount text-right">
                                                        @if ($row1->debit_credit == 0)
                                                            {{ number_format($row1->amount, 2) }} @php $total_credit+=$row1->amount  @endphp
                                                        @endif
                                                    </td>
    ...
    <script type="text/javascript">
        ...
        function removeHideFromRow(){
            $('.removeHide').removeClass('hide')
        }
        function completeAndMakePR(){
            let id = [];
            let grnNo = $('input[name="grnNo"]').val();
            $('input[name="grnForComplete"]:checked').each(function() {
                id.push(this.value);
            });

            if(id.length == 0){
                alert("Select Item for complete");
                return;
            }

            $.ajax({
                url: "{{route('pdc.completeAndMakePR')}}",
                type: "get",
                data: {id: id, grnNo:grnNo},
        ...
        function approveCompanyPurchaseGoodsReceiptNote(m, voucherStatus, rowStatus, columnValue, columnOne, columnTwo,
            columnThree, tableOne, tableTwo) {
            $.ajax({
        ...
        function checkQty(paramOne, paramTwo, paramThree) {
            ...
            if (parseInt(paramTwo) <= parseInt(remainingQty)) {} else {
                $('#' + paramThree + '').val('');
