						...
						<div class="well">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<span class="subHeadingLabelClass">Add Supplier</span>
										</div>
									</div>
									...
									<div class="panel">
										<div class="panel-body">
											<div class="row">
												<?php
													echo Form::open(array('url' => 'pad/addSupplierDetail','id'=>'addSupplierForm'));
												?>
													<input type="hidden" name="_token" value="{{ csrf_token() }}">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<label>Account Head</label>
														<select style="display: none" name="account_head" id="account_head" class="form-control">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<span class="subHeadingLabelClass">View Supplier</span>
										</div>
									</div>
									<div class="lineHeight">&nbsp;</div>
									<div class="panel">
...
<script type="text/javascript">
	$(document).ready(function() {
		function viewSupplierList(){
			$('#viewSupplierList').html('<tr><td colspan="5"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center"><div class="loader"></div></div></div></div></td><tr>');
			$.ajax({
		...
		$(function(){
			$('#addSupplierForm').on('submit',function(e){
        		...
        		$.ajax({
					type:"POST",
        			url:'<?php echo url('/')?>/pad/addSupplierDetail',
        			data:$(this).serialize(),
        			dataType: 'json',
        			success: function(data){
            			console.log(data);
