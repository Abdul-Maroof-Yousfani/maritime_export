...
@section('content')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well_N">
                    <div class="dp_sdw">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">Create BOM Form</span>
                            </div>
                        </div>
                        <div class="lineHeight">&nbsp;</div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                {{ Form::open(['url' => 'workshop/addMaintenanceInvoiceDetail?m=' . $m . '', 'id' => 'cashPaymentVoucherForm', 'class' => 'stop']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div id="getMaintenanceJobDataForMaintenanceInvoice"></div>
                                </div>
                                <?php echo Form::close(); ?>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function getMaintenanceJobDataForMaintenanceInvoice() {
            $('#getMaintenanceJobDataForMaintenanceInvoice').html(
            ...
            $.ajax({
                url: '<?php echo url('/'); ?>/workshop/getMaintenanceJobDataForMaintenanceInvoice',
                method: 'GET',
                data: {
                ...
                success: function(response) {
                    $('#getMaintenanceJobDataForMaintenanceInvoice').html(response);
                }
            });
        }
    </script>
