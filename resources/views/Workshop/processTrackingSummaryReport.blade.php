                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">View Process Tracking Summary Report</span>
                                    </div>
                                </div>
                                                            ...
                                                            <table id="table" class="table table-bordered sf-table-list">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th colspan="5" class="text-center">Maintenance Job Detail</td>
                                                                        <th colspan="9" class="text-center">BOM Detail</td>
                                                                        <th colspan="3" class="text-center">Gate Pass Out Detail</td>
                                                                        <th colspan="3" class="text-center">Gate Pass In Detail</td>
                                                                        <th colspan="4" class="text-center">Goods Receipt Note Detail</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">M.J.Vendor</th>
                                                                        ...
                                                                        <th class="text-center">GRN.Repair Cost</th>
                                                                        <th class="text-center">Status</th>
        ...
        <script !src="">
            function ExportToExcel(type, fn, dl) {
                ...
                return dl ?
                    ...
                    XLSX.writeFile(wb, fn || ('Process Tracking SummaryReport.' + (type || 'xlsx')));
            }
            //viewSubItemList();
        </script>
        <script>
            ...
            function getProcessTrackingSummaryReport() {
                ...
                let url = "";
                url = '<?php echo url('/'); ?>/workshop/processTrackingSummaryReport';
