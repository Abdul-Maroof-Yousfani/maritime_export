    ...
    <div class="well_N">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">View Analyzing Report List</span>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function getMaintenanceRequestList() {
                ...
                $.ajax({
                    url: '<?php echo url('/'); ?>/workshop/viewAnalyzingReportDetail',
                    method: 'GET',
                    data: {from_date:from_date, last_date:last_date},
                    error: function() {
                        alert('error');
                    },
            ...
            function deleteAnalysingMr(id) {
                // alert("Delete Working");
                if(confirm('Are u sure want to delete this?')){
                    $.ajax({
                        url: '{{ url('/workshop/deleteAnalyzingMr') }}',
                        data: {
                            id: id
                        },
                        type: 'GET',
