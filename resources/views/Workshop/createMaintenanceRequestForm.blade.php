            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well_N">
                    <div class="dp_sdw">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">Create Maintenance Request Form</span>
                            </div>
                        </div>
                        <div class="lineHeight">&nbsp;</div>
                        <div class="row">
                            {{ Form::open(['url' => 'workshop/addMaintenanceRequestDetail?m=' . $m . '', 'id' => 'cashPaymentVoucherForm', 'enctype' => 'multipart/form-data', 'class' => 'stop']) }}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <input type="text" readonly class="form-control"
                                                    value="{{ CommonHelper::getMRVoucherNumber() }}">
                                            </div>
                                        ...
                                        <div class="row" id="form">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <input type="date" class="form-control requiredField"
                                                    name="submit_date" id="submit_date" />
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <label for="">Damage Detail</label>
                                                <textarea class="form-control requiredField" name="description" id="description" cols="5" rows="5"></textarea>
                                            </div>
