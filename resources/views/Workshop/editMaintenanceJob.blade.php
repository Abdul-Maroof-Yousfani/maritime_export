            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well_N">
                    <div class="dp_sdw">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">Edit Maintenance Job Form</span>
                            </div>
                        </div>
                        <div class="lineHeight">&nbsp;</div>
                        <div class="row">
                            {{ Form::open(['url' => 'workshop/maintenanceJobUpdate?m=' . $m . '', 'id' => 'cashPaymentVoucherForm', 'enctype' => 'multipart/form-data', 'class' => 'stop']) }}
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                ...
                                                <select name="maintenance_request_id" id="maintenance_request_id"
                                                    ...
                                                    <option value="{{$maintenanceJob->maintenanceRequest->id}}">{{$maintenanceJob->maintenanceRequest->voucher_no}}</option>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select name="job_type" id="job_type"
                                                    ...
                                                    <option value="1"{{($maintenanceJob->job_type == 1)? 'selected' : ''}}>In-House</option>
                                                    <option value="2"{{($maintenanceJob->job_type == 2)? 'selected' : ''}}>Outsource</option>
                                                    <option value="3"{{($maintenanceJob->job_type == 3)? 'selected' : ''}}>In-House (another warehouse)</option>
                                                    <option value="4" {{($maintenanceJob->job_type == 3)? 'selected' : ''}}>In-House Corrective Maintenace</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <label for="">Voucher Date</label>
                                                <input type="date" class="form-control" id="voucher_date"
                                                    name="voucher_date" value="{{ $maintenanceJob->voucher_date }}">
                                                <input type="hidden" name="id" value="{{ $maintenanceJob->id }}">
                                            </div>
                                            <div id="inhousePortion">
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    ...
                                                    <select name="warehouse_id" id="warehouse_id" class="form-control select2">
                                                        ...
                                                        @foreach (ReuseableCode::getUserWiseLocationRightsData() as $warehouse)
                                                            <option value="{{ $warehouse->id }}" {{($warehouse->id == $maintenanceJob->warehouse_id)? 'selected' : '' }}>
                                                                {{ $warehouse->location_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 hide" id="anotherPortion">
                                                    <label for="">Repairing Location To</label>
                                                    <select name="warehouse_id_to" id="warehouse_id_to"
                                                        class="form-control select2">
                                                        <option value="">Select Warehouse</option>
                                                        @foreach (ReuseableCode::getUserWiseLocationRightsData() as $warehouse)
                                                            <option value="{{ $warehouse->id }}" {{($warehouse->id == $maintenanceJob->warehouse_id_to)? 'selected' : '' }}>
                                                                {{ $warehouse->location_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <select name="supplier_id" id="supplier_id" class="form-control select2"
                                                    ...
                                                    @foreach (CommonHelper::get_all_supplier() as $supplier)
                                                        <option value="{{ $supplier->id }}" {{($supplier->id == $maintenanceJob->supplier_id)? 'selected' : '' }}
                                        ...
                                        <div class="row" id="form">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <input type="text" id="mr_department" class="form-control requiredField "
                                                    readonly value="{{$maintenanceJob->maintenanceRequest->department->sub_department_name}}">
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label for="">MR Warehousue</label>
                                                <input type="text" id="mr_warehouse"
                                                    class="form-control requiredField " readonly value="{{$maintenanceJob->maintenanceRequest->warehouse->name}}">
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label for="">MR Machine</label>
                                                <input type="text" id="mr_machine" class="form-control requiredField "
                                                    readonly value="{{$maintenanceJob->maintenanceRequest->machine->name}}">
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label for="">MR Line</label>
                                                <input type="text" id="mr_line" class="form-control requiredField "
                                                    readonly value="{{$maintenanceJob->maintenanceRequest->line->name}}">
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label for="">Requested Submit Date</label>
                                                <input type="date" id="mr_sumit_date"
                                                    class="form-control requiredField " readonly value="{{$maintenanceJob->maintenanceRequest->submit_date}}">
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <textarea class="form-control" name="description" id="description" cols="5" rows="5">{{$maintenanceJob->description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="lineHeight">&nbsp;</div>
                                        <div class="row">
