    ...
    <div class="well_N">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">View Maintenance Job List</span>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function getMaintenanceJobList() {
                ...
                let url = "";
                url = '<?php echo url('/'); ?>/workshop/MaintenanceJobList';
            ...
            function deleteMaintenanceJob(id) {
                ...
                if(confirm('Are u sure you want to delete this?')){
                    $.ajax({
                        url: '{{ url('/workshop/deleteMaintenanceJob') }}',
                        data: {
                            item: id
                        },
                        type: 'GET',
