                ...
                <div class="dp_sdw">    
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <span class="subHeadingLabelClass">Duties Clearing List</span>
                            </div> 
                    ...
                    <div class="row">
                        ...
                        <span id="ShowHideSoNo">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <label>SCCD  No</label>
                                <input type="text" name="packing_list_no" id="sccd" class="form-control" placeholder="SCCD  No"  />
                            </div>
                          
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 ">
                                <input type="button" value="View Filter" class="btn btn-sm btn-danger" onclick="viewRangeWiseDataFilter();" style="margin-top: 32px;" />
                            </div>
                        </span>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <th class="text-center col-sm-1">SCCD NO</th>
    ...
    <script>
        ...
        function viewRangeWiseDataFilter()
        {
            ...
            // $('#data').html('<tr><td colspan="13"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div></div></td><tr>');
                var base_url='<?php echo URL::to('/'); ?>';
            $.ajax({
                url: base_url+'/export/DutiesListAjax',
                type: 'Get',
                data: {commercial:commercial,m:m,sccd:sccd},
