...
@section('content')
                        ...
                        <div class="row">
                            ...
                            {{-- <span id="ShowHideSoNo">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <input type="text" name="contract" id="commercial" class="form-control"
                                        placeholder="Commercial invoice " />
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <label>BOL No</label>
                                    <input type="text" name="packing_list_no" id="packing_list_no" class="form-control"
                                        placeholder="Bol No" />
                                </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                                <thead>
                                                    <tr style="background-color: darkgrey;font-size: 20px;">
    ...
    <script>
        ...
        function viewRangeWiseDataFilter() {
            ...
            var base_url = '<?php echo URL::to('/'); ?>';
            $.ajax({
                url: base_url + '/export/billOfLadingListAjax',
                type: 'Get',
                data: {
