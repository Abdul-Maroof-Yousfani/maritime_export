...
@section('content')
                                        ...
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        @php
                                                            echo Form::open(['url' => 'export/updateBillOfLading/'.$bol->id.'?m=' . $m . '', 'id' => 'addSubItemDetail']);
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    name="voucher_date" value="{{ $bol->voucher_date }}"
                                                                    id="">
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                                                ...
                                                                <textarea name="consignee" id="consignee" cols="30" rows="10">{{ $bol->consignee }}</textarea>
                                                                {{-- <div style="height: 150px; background-color: #eee; padding: 10px;">
                                                                    {!! $sales_order->consignee !!}
                                                                </div> --}}
                                                            </div>
                                                            ...
                                                            <div id="notifyMoreField">
                                                                ...
                                                                @foreach ($bol->bol_notify as $key => $invoiceNoti)
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"
                                                                        ...
                                                                        <textarea type="text" class="form-control" name="notify_address[]" id="notify_address{{ $key }}">{{ $invoiceNoti->notify_detail }}</textarea>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <label class="sf-label">Product Details </label>
                                                                <textarea name="bol_description" id="bol_description" cols="30" rows="10">{{ $bol->description }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="lineHeight">&nbsp;&nbsp;&nbsp;</div>
                                                        <div class="row">
    ...
    <script type="text/javascript">
        var Counter = {{ count($bol->bol_notify) }}
        $(function() {
