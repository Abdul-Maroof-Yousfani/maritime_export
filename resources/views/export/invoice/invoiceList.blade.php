                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <span class="subHeadingLabelClass">View Commercial Invoice List</span>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered sf-table-list" id="EmpExitInterviewList">
                                            ...
                                            <th class="text-center col-sm-1">EXPORT ORDER NO </th>
                                            <th class="text-center col-sm-1">PROFORMA NO </th>
                                            <th class="text-center col-sm-1">COMMERCIAL INVOICE NO</th>
                                            <th class="text-center col-sm-1">COMMERCIAL INVOICE DATE</th>
                                            <th class="text-center col-sm-1">LC DATE</th>
                                            <th class="text-center col-sm-1">E-FORM NO</th>
                                            <th class="text-center col-sm-1">Packing List Status</th>
    ...
    <script>
        ...
        function viewRangeWiseDataFilter()
        {
            ...
            // $('#data').html('<tr><td colspan="13"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div></div></td><tr>');
                var base_url='<?php echo URL::to('/'); ?>';
            $.ajax({
                url: base_url+'/export/invoiceListAjax',
                type: 'Get',
                data: {Eono: Eono,commercial:commercial,m:m,proforma:proforma},
