                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <span class="subHeadingLabelClass">Commercial Invoice Creation</span>
                            </div>
    ...
    <script>
        ...
        function viewRangeWiseDataFilter()
        {
            ...
            // $('#data').html('<tr><td colspan="13"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div></div></td><tr>');
                var base_url='<?php echo URL::to('/'); ?>';
            $.ajax({
                url: base_url+'/export/createExportInvoiceListAjax',
                type: 'Get',
                data: {Proforma:Proforma,contract:contract,EoNo:EoNo},
