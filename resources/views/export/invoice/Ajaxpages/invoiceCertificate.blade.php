        ...
        <div class="table-responsivecoverray commercial_table">
            <table class="ecoverray table table-bordered newcommericals  sf-table-list  commercial_table2" id="EmpExitInterviewList ">
                ...
                <tbody>
                    ...
                    @endif
                    <td class="dragon_td_no_border2"></td>
                    ...
                    @if ($loop->last)
                        ...
                        @if ($advance > 0)
                            <tr>
                                ...
                                @php
                                    $sumtotal = $sumtotal - ($advance/$exportInvoices->currencey_rate);
                                @endphp
                                <td class="dragon_td_no_border5">({{ $name_currency. '   ' .$advance/$exportInvoices->currencey_rate }})</td>
                            </tr>
                        @endif
                        <tr>
                            <td colspan="4">{{ $value->brand }}</td>
                            <td>
            ...
            {{-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="line-height: 19px;"> 
                            <br> <strong><b>INTERMEDIARY BANK</b></strong>
                                    ...
                                    <br>ACCOUNT Title: {{$exportInvoices->account_title}} 
