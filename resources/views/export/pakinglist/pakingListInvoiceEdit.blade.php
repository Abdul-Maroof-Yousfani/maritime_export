...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Edit Packing List Details</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        @php
                                                            echo Form::open(['url' => 'export/pakingListUpdate?m=' . $m . '', 'id' => 'addSubItemDetail']);
                                                        @endphp
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                        <input type="hidden" name="paking_id"
                                                            value="{{ $pakinglist->id }}">
                                                        <input type="hidden" name="invoice_id"
                                                            value="{{ $pakinglist->invoice->id }}">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                <label for="">Packaging invoice No</label>
                                                                <input type="text" class="form-control" readonly
                                                                    name="packaging_invoice_no" value="{{$pakinglist->import_no}}"
                                                                    id="">
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                ...
                                                                <input type="date" class="form-control"
                                                                    ...
                                                                    value="{{$pakinglist->import_date}}" id="">
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                <label for="">Proform No</label>
                                                                <input readonly type="text" class="form-control"
                                                                    name="proforma_invoice_no"
                                                                    value="{{ $pakinglist->invoice->proforma->pro_contract_no }}" id="">
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                <label for="">Commercial Invoice No</label>
                                                                <input readonly type="text" class="form-control"
                                                                    name="commercial_invoive_no"
                                                                    value="{{ $pakinglist->invoice->commercial_invoice_no }}"
                                                                    id="">
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                ...
                                                                <input readonly type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $pakinglist->invoice->exportOrder->voucehr_no }}" />
                                                            </div>
                                                            <div class="col-lg-3 col-md-2 col-sm-2 col-xs-8">
                                                                <label class="sf-label">Buyer's Name </label>
                                                                <input readonly type="text" class="form-control"
                                                                    placeholder="" name="buyers_id" id="buyers_id"
                                                                    value="{{ CommonHelper::byers_name($pakinglist->invoice->exportOrder->buyer_id)->name ?? '-' }}" />
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                                ...
                                                                <input readonly type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $pakinglist->invoice->itemData->sum('issue_qty') }}" />
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                                ...
                                                                <input readonly type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $pakinglist->invoice->itemData->sum('gross_weight') }}" />
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <textarea class="form-control"
                                                                    ...
                                                                    id="consignee"
                                                                    value="">{{$pakinglist->consignee}}</textarea>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                ...
                                                                <textarea class="form-control"
                                                                    ...
                                                                    id="notify"
                                                                    value="">{{$pakinglist->notify}}</textarea>
                                                            </div>
                                                             ...
                                                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tbody id="AppnedHtml">
                                                                             @foreach ($pakinglistdata as $key => $item)
                                                                                <tr class="cnt">
                                                                                    <td>
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                    ...
                                                                                    <td><input type="text"
                                                                                            ...
                                                                                            name="net_weight[]"
                                                                                            onkeyup="calculationPackaging()"
                                                                                            id="net_weight{{$key}}" value="{{$item->net_weight}}">
                                                                                    </td>
                                                                                    <td><input type="text"
                                                                                            class="form-control gross_weight"
                                                                                            name="gross_weight[]"
                                                                                            onkeyup="calculationPackaging()"
                                                                                            id="gross_weight{{$key}}" value="{{$item->gross_weight}}">
                                                                                    </td>
                                                                                    <td><button class="btn btn-danger btn-xs" onClick="removeSection({{$key}})">Remove</button></td>
    ...
    var counter = {{count($pakinglistdata)}};
