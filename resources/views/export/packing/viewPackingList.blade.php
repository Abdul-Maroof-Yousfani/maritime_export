...
@section('content')
                        ...
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <a href="{{route('packingCreateForm')}}" class="btn btn-success pull-right">Add Packing</a>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        function viewPackingList(){
            ...
            var counter =1;
            $.ajax({
                url: '<?php echo url('/')?>/export/viewPackingListAjax',
                type: "GET",
                data:{m:m},
                success:function(data) {
                    console.log(data);
                    setTimeout(function(){          
                        $('#viewPackingList').html(data);
                    },1000);
                }
            });
        }
