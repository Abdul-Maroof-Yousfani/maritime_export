                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <form action="{{ route('gate_pass.update_gatepass') }}"  method="post"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input type="text" name="date" id="date"
                                                                value="{{ date('d-m-Y', strtotime($GatePassReturnable->date )) }}"
                                                                class="form-control requiredField" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Ref No:</label>
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            ...
                                                            <input type="text" name="ref_date" id="date"
                                                                value="{{ date('d-m-Y', strtotime($GatePassReturnable->ref_date )) }}"
                                                                class="form-control requiredField" />
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label>Type:</label>
