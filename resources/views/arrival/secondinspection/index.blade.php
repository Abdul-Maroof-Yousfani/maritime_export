                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">View Rice Analysis and Inspection Report List (Second)</span>
                                        <div class="row">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table id="table" class="table table-bordered">
                                                                <thead>
                                                                    ...
                                                                    <th class="text-center">Inpection No </th>
...
{{--                                                                    <th class="text-center">Status</th>--}}
    ...
    <script>
        ...
        function FetchPOList() {
            ...
            $.ajax({
                url: '{{ url('arrival/second_inspection') }}',
