                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Rice Analysis and Inspection Report (Second)</span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <form enctype="multipart/form-data" action="{{ route('secondinspection.store') }}" method="post"
                                                          id="yourFormId2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <select name="po_no" id="po_no"
                                                                    class="form-control requiredFieldbkk select2 requiredFieldbkk" onchange="get_second_inspection(this.value,1); ">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <select name="first_ins_no"  id="inspection_no" onchange= " getChecklist(this.value);getProductDescription(this.value);"
...
{{--                                                        </div>--}}
    ...
    <script type="text/javascript">
        ...
        function getProductDescription(id) {
            ...
            $.ajax({
                url: '{{ url('/') }}' + '/arrival/getProductDescriptionForSecond/' + id,
                type: 'Get',
                data: {
                    po_no: po_no
                },
        ...
        function getChecklist(id) {
            ...
            var po_no = $('#po_no option:selected').val();
            $.ajax({
                url: '{{ url('/') }}' + '/arrival/getChecklistSecond/' + id,
                type: 'Get',
                data: {
                    po_no: po_no
                },
