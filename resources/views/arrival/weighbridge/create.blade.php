                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Create Weighbridge</span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <form enctype="multipart/form-data" action="{{ route('weighbridge.store') }}" method="post"
                                                          id="yourFormId2" >
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <select name="po_no" id="po_no"
                                                                        ...
                                                                        onchange="get_inspection_no(this.value,'arrival_weighbridges','1')"
                                                                >
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <input type="text" name="weighbridge_no" readonly
                                                                       id="get_pass_no" value="{{ CommonHelper::getProductionFormat(ArrivalWeighbridge::class,'WBR-1-') }}"
                                                                ...
                                                                <select name="location_id" id="location_id" class="form-control requiredFieldbkk select2">
                                                                    @foreach($parentlocations as $parent)
                                                                        @if (is_null($parent->parent_id))
                                                                            ...
                                                                            <option  disabled value="{{ $parent->id }}">{{ $parent->name }}</option>
                                                                            <!-- Loop through to display children with matching parent_id -->
                                                                            @foreach($parentlocations as $child)
                                                                                @if ($child->parent_id == $parent->id)
                                                                                    <!-- Nested child option -->
                                                                                    <option value="{{ $child->id }}">------ {{ $child->name }}</option>

                                                                                    <!-- Check for further nested children -->
                                                                                    @foreach($parentlocations as $subChild)
                                                                    ...
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-center"
                                                                                style="width: 20%;">
                                                                                No of Pkgs</th>
                                                                            <th  style="width: 40%;" class="text-center">Description Of Goods </th>
{{--                                                                            <th class="text-center">1st Weight</th>--}}
{{--                                                                            <th class="text-center">2nd Weight</th>--}}
...
{{--                                                                                       class="form-control requiredFieldbkk " name="first_weight"--}}
{{--                                                                                       id="first_weight" value="">--}}
{{--                                                                            </td>--}}
{{--                                                                            <td><input type="number"--}}
{{--                                                                                       class="form-control requiredFieldbkk " name="second_weight"--}}
{{--                                                                                       id="first_weight" value="">--}}
{{--                                                                            </td>--}}
                                                                            <td><input type="number"
    ...
    <script type="text/javascript">
        ...
        function get_details() {
            ...
            $('#consignee_weight').val(consignee_weight);
            $('#vehicle_no').val(vehicle_no);
            $('#shipment_origin').val(shipment_origin);
        ...
        function get_gate_pas() {
            ...
            $.ajax({
                url: '{{ url('/') }}' + '/arrival/weighbridge/create?id='+id,
                type: 'Get',
                success: function(response) {
                    $('#gate_pass_no').html('');
