                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">View Weighbridge Slip List</span>
                                        <div class="row">
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table id="table" class="table table-bordered">
                                                                <thead>
                                                                    ...
                                                                    <th class="text-center">Weighbridge NO</th>
                                                                    <th class="text-center">GP NO</th>
                                                                    <th class="text-center">Inspection No</th>
                                                                    <th class="text-center">Vehicle No</th>
                                                                    <th class="text-center">Date</th>
                                                                    <th class="text-center">No Of Pkgs</th>
                                                                    <th class="text-center">Consignee Weight</th>
                                                                    <th class="text-center">Goods Description</th>
                                                                    <th class="text-center">Weight</th>
                                                                    <th class="text-center">Transfer Location</th>
