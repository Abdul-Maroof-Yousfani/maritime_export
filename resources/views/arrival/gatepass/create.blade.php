                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Create Inward Gate Pass</span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <form enctype="multipart/form-data" action="{{ route('getpass.store') }}" method="post"
                                                          id="yourFormId2" >
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <select name="po_no" id="po_no"
                                                                    ...
                                                                    onchange="get_inspection_no(this.value,'production_get_pass','1')"
                                                                    >
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <input type="text" name="gate_pass_no" readonly
                                                                    id="gate_pass_no" value="{{CommonHelper::getProductionFormat(ProductionGatePassIn::class,'GIN-') }}"
                                                                            ...
                                                                            <tr class="cnt" id="removeSection1">
                                                                                ...
                                                                                <td>
                                                                                        <select disabled name="product_id" id="product_id"
                                                                                            class="form-control requiredFielbk select2"
                                                                                            onchange="getProductSlabsDetail()">
                                                                                        </select>
                                                                                </td>
                                                                                <td><input type="number"
                                                                                        class="form-control requiredFielbk " disabled name="total_qty"
                                                                                        id="total_qty"  value="">
                                                                                </td>
                                                                                <td><input readonly type="number"
                                                                                        class="form-control requiredFielbk " name="recived_qty"
                                                                                        id="recived_qty" value="">
                                                                                </td>
                                                                                <td ><textarea type="text"
                                                                                        class="form-control requiredFielbk" name="description"
                                                                                        id="rate1" ></textarea>
        ...
        function AddMoreDetails() {
            ...
            if(counter == 1){
                ...
                `<tr class="cnt" id="removeSection${counter}">
                    ...
                    <td><input type="number"
                            class="form-control requiredFielbk " name="qty"
                            id="qty${counter}" onkeyup="calculate(${counter})" value="">
                    </td>
                    <td ><input type="number"
                            class="form-control requiredFielbk" name="order_rate"
                            id="rate${counter}" onkeyup="calculate(${counter})" value="">
                    </td>
                    <td ><input type="text"
                            class="form-control requiredFielbk" name="po_amount"
