            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-primary" >
                            <th  class="bg-primary" style="width: 40%"  style="width: 40%;">
                                Particulars
                            </th>
                            <th class="bg-primary" style="width: 30%"  >First Report</th>
                            <th class="bg-primary"style="width: 30%"   >Second Report</th>
                        </tr>
                        </thead>

                        <tbody id="AppnedHtml">
                        @if(count($checklists) != 0)
                            @foreach($checklists as $key => $qc)
                                <tr>
                                    <th style="width: 40%" style="width: 40%;">
                                        {{ $qc->name}}
                                        <input type="hidden" value="{{$qc->id}}" name="checklist_id[]">
                                    </th>
                                    <th style="width: 30%" class="">
                                        @php
                                            $first_checklists = DB::connection('mysql2')->table('arrival_inspections')
                                            ->join('inpection_checklists' , 'inpection_checklists.ins_id' , 'arrival_inspections.id')
                                            ->where('arrival_inspections.ins_no',$inspections->first_ins_no)
                                            ->where('inpection_checklists.checker_id' , $qc->id)
                                            ->select('inpection_checklists.comment')
                                            ->first()
                                        @endphp
                                        {{$first_checklists->comment ?? '--'}}
                                    </th>
                                    <th style="width: 30%" class="">
                                        {{$qc->comment}}
                                    </th>
...
{{--                    </td>--}}
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        {{optional($inspections->moisture1)->received_qty}}
                    </td>
{{--                    <td>--}}
{{--                        {{optional($inspections->moisture1)->deduction}}--}}
{{--                    </td>--}}
                    <td>
                        {{optional($inspections->moisture1)->total_deduction}}
                    </td>
                    <td>
                        {{optional($inspections->moisture1)->total_deduction_update}}
                    </td>
                ...
                <tr>
                   ...
                   <td>
                    {{optional($inspections->broken1)->received_qty}}
                   </td>
{{--                   <td>--}}
{{--                    {{optional($inspections->broken1)->deduction}}--}}
{{--                   </td>--}}
                   <td>
                    {{optional($inspections->broken1)->total_deduction}}
                   </td>
                    <td>
                    {{optional($inspections->broken1)->total_deduction_update}}
                   </td>
                </tr>
                <tr>
                    <td>
                   ...
                   <td>
                        {{optional($inspections->damage1)->received_qty}}
                   </td>
{{--                   <td>--}}
{{--                        {{optional($inspections->damage1)->deduction}}--}}
{{--                    </td>--}}
                    <td>
                        {{optional($inspections->damage1)->total_deduction}}
                    </td>
<td>
                        {{optional($inspections->damage1)->total_deduction_update}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {{optional($inspections->chobba1)->received_qty}}
                    </td>
{{--                    <td>--}}
{{--                        {{optional($inspections->chobba1)->deduction}}--}}
{{--                    </td>--}}
                    <td>
                        {{optional($inspections->chobba1)->total_deduction}}
                    </td>
                    <td>
                        {{optional($inspections->chobba1)->total_deduction_update}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {{optional($inspections->look1)->received_qty}}
                    </td>
{{--                    <td>--}}
{{--                        {{optional($inspections->look1)->deduction}}--}}
{{--                    </td>--}}
                    <td>
                        {{optional($inspections->look1)->total_deduction}}
                    </td>
                    <td>
                        {{optional($inspections->look1)->total_deduction_update}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {{optional($inspections->o_v1)->received_qty}}
                    </td>
{{--                    <td>--}}
{{--                        {{optional($inspections->o_v1)->deduction}}--}}
{{--                    </td>--}}
                    <td>
                        {{optional($inspections->o_v1)->total_deduction}}
                    </td>
                    <td>
                        {{optional($inspections->o_v1)->total_deduction_update}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {{optional($inspections->chalky1)->received_qty}}
                    </td>
{{--                    <td>--}}
{{--                        {{optional($inspections->chalky1)->deduction}}--}}
{{--                    </td>--}}
                    <td>
                        {{optional($inspections->chalky1)->total_deduction}}
                    </td>
                    <td>
                        {{optional($inspections->chalky1)->total_deduction_update}}
                    </td>
                </tr>
            </tbody>
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    didOpen: () => {
                        Swal.showLoading();
                        $.ajax({
                            url: '{{ url('/') }}' + '/arrival/approveSecondInspection/' + id,
                            type: 'POST',
                            headers: {
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    didOpen: () => {
                        Swal.showLoading();
                        $.ajax({
                            url: '{{ url('/') }}' + '/arrival/rejectSecondInspection/' + id,
                            type: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': '{{ csrf_token() }}'
                            },
