    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="dp_sdw">    
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <span class="subHeadingLabelClass">Create Factory Overhead </span>
                    </div>
                </div>
                <div class="lineHeight">&nbsp;</div>
                <div class="row">
                    <?php echo Form::open(array('url' => 'prad/add_factory_over_head?m='.$m.'','id'=>'bom_form','class'=>'stop'));?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="sf-label">Factory Overhead Name. <span class="rflabelsteric"><strong>*</strong></span></label>
                                                <input type="text" class="form-control required" id="name" name="name" placeholder="Factory overhead Name">
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                <label class="sf-label">Factory Overhead Category. <span class="rflabelsteric"><strong>*</strong></span></label>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <textarea  name="desc" id="desc" rows="3" cols="40" style="resize:none;" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive" id="">
                                            <table class="table table-bordered">
                                                ...
                                                <tr class="text-center">
                                                    <th colspan="4" class="text-center">Factory Overhead Detail</th>
                                                ...
                                                <tr id="" class="AutoNo">
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control required" id="amount1" name="amount[]" step="any" placeholder="Amount" onkeyup="CostCalc(1)">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control required" id="no_of_piece1" name="no_of_piece[]" step="any" placeholder="No Of Piece" onkeyup="CostCalc(1)">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control required" id="cost1" name="cost[]" step="any" placeholder="" readonly>
                                                    </td>
                                                    <td>-</td>
                                                </tr>
                                                </tbody>
