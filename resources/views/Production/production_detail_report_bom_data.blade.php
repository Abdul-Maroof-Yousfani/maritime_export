...
@foreach($bom_data as $row1)
    ...
    <tr class="text-center">
        ...
        <?php $variance=((($net_issue_qty - $request_qty ) / $request_qty)*100) ?>
        <td @if($variance<0) style="background-color: lightcoral" @endif> {{ number_format((($net_issue_qty - $request_qty ) / $request_qty)*100 ,2).'%' }} </td>
    </tr>
