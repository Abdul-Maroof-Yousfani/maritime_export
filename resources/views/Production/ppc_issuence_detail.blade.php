        ...
        <div class="">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h3 style="text-align: center;">View Issuence Against Plan </h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table  class="table table-bordered table-striped table-condensed tableMargin">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Issued User</th>
                        </tr>
                        </thead>
                        ...
                        $counter = 1;
                        foreach ($ppc_issue_data as $row):


                                //
                                if ($row->type==0):
                                    $table='production_bom_data_direct_material';
                                else:
                                    $table='production_bom_data_indirect_material';
                                endif;
                              $bom_data=  ProductionHelper::get_bom_detail($table,$row->bom_data_id);
                        ...
                        <tr class="tex-center">
                            ...
                            <td  class="text-center"><?php echo CommonHelper::get_item_name($row->finish_goods_id);?>
                            <td  class="text-center"><?php echo $item_name;?>
                            <td  class="text-center"><?php echo $row->issue_qty;?>
                            <td  class="text-center"><?php echo CommonHelper::new_date_formate($row->date);?>
                            <td  class="text-center"><?php echo ucwords($row->username);?>
                            </td>
