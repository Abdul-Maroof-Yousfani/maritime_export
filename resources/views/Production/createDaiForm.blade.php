                        ...
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <span class="subHeadingLabelClass">Create Die Form</span>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <input type="text" name="DaiName" id="DaiName" class="form-control requiredField" placeholder="Die Name" onkeyup="RemoveMsg()">
                                                </div>
            ...
            $(".btn-success").click(function(e){
                ...
                for (val of category) {
                    ...
                    if(validate == 0)
                    {
                        ...
                        var life = $('#life').val();
                        $.ajax({
                            url:'{{url('/production/insert_dai')}}',
                            data:{DaiName:DaiName,BatchCode:BatchCode,Size:Size,life:life},
                            type:'GET',
