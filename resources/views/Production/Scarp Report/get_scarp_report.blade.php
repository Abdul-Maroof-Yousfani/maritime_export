...
<table id="data_table" class="table table-bordered">
    ...
    <th class="text-center">Scrap Quantity</th>
    </thead>
    <tbody>
    <?php
    $count=1;
    ...
    @foreach($data as $row)
        ...
        <tr class="text-center">
            ...
            <td><?php echo  number_format($row->wastage_per_pirece,2) ?></td>
        ...
        $total_scrap+=$row->wastage_per_pirece;
        ?>
    @endforeach
    <tr class="text-center" style="font-size: large;font-weight: bold">
        ...
        <td><?php echo number_format($total_scrap,2) ?></td>
