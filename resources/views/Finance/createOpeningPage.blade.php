                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table table-bordered sf-table-list" id="bankPaymentVoucherList">
                                                                ...
                                                                elseif($level == 7){echo $colour='smr-lightblue';}?>"
                                                                    ...
                                                                    $Trans = DB::Connection('mysql2')->table('transactions')->where('acc_id',$row->id)->where('opening_bal',1)->where('status',1)->select('debit_credit','amount')->first();
                                                                        $TranCount = $Trans;
                                                                    ?>
                                                                    <td class="text-center">
                                                                        <select name="tran_type<?php echo $row->id?>" id="tran_type<?php echo $row->id?>" class="form-control" style="margin: 5px 5px 5px 5px;">
                                                                            ...
                                                                            <option value="1" <?php if($TranCount): if($Trans->debit_credit == 1){echo "selected";} endif;?>>Debit</option>
                                                                            <option value="0" <?php if($TranCount): if($Trans->debit_credit == 0){echo "selected";} endif;?>>Credit</option>
                                                                        </select>
                                                                        <span id="TranTypeError<?php echo $row->id?>"></span>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <input type="number" id="opening_amount<?php echo $row->id?>" name="opening_amount<?php echo $row->id?>" class="form-control" placeholder="OPENING BAL" style="margin: 5px 5px 5px 5px;" value="<?php if($TranCount): echo $Trans->amount; endif;?>">
