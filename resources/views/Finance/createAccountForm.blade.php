                            ...
                            <div class="dp_sdw">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        {{-- <a href="{{url('/uploadChartsOfAccounts')}}" class="btn btn-primary btn-xs">Upload</a> --}}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                <div class="row">
                                                    <?php echo Form::open(['url' => 'fad/addAccountDetail?m=' . $m . '', 'id' => 'chartofaccountForm']); ?>
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <input type="hidden" name="chartofaccountSection[]"
                                                            class="form-control" id="chartofaccountSection"
                                                            value="1" />
                                                    </div>
                       ...
                       <!-->
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" name="operational" value="1"
                                                                    checked="checked" /> <b>Operational</b>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <select onchange="get_nature_type()" class="form-control select2"
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <input type="text" autofocus="autofocus"
                                                            placeholder="New Account" class="form-control requiredField"
                                                            name="acc_name" id="acc_name" value=""
                                                            autocomplete="off">
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <input type="any" name="o_blnc" maxlength="15"
                                                                    min="0" id="o_blnc"
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <select name="o_blnc_trans" id="o_blnc_trans"
