            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                        <?php echo CommonHelper::displayPrintButtonInBlade('printPurchaseBankPaymentVoucherList','','1');?>
                        <?php echo CommonHelper::displayExportButton('purchaseBankPaymentVoucherList','','1')?>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <span class="subHeadingLabelClass">View Purchase Bank Payment Voucher List</span>
                                </div>
                            </div>
                            <div class="lineHeight">&nbsp;</div>
                            <input type="hidden" name="functionName" id="functionName" value="fdc/filterPurchaseBankPaymentVoucherList" readonly="readonly" class="form-control" />
                            <input type="hidden" name="tbodyId" id="tbodyId" value="filterPurchaseBankPaymentVoucherList" readonly="readonly" class="form-control" />
                            ...
                            <div class="lineHeight">&nbsp;</div>
                            <div id="printPurchaseBankPaymentVoucherList">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered sf-table-list" id="purchaseBankPaymentVoucherList">
                                                            <thead>
                                                            ...
                                                            <tbody id="filterPurchaseBankPaymentVoucherList"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
                                    <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(200)->generate('View Purchase Bank Payment Voucher List'))!!} ">
                                </div>
                            </div>
                            </div>
                        </div>
