...
@section('content')
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="well">
							...
							<div class="lineHeight">&nbsp;</div>
							<input type="hidden" name="functionName" id="functionName" value="fdc/filterBankReceiptVoucherList" readonly="readonly" class="form-control" />
							<input type="hidden" name="tbodyId" id="tbodyId" value="filterBankReceiptVoucherList" readonly="readonly" class="form-control" />
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="table-responsive">
														<table class="table table-bordered sf-table-list" id="bankReceiptVoucherList">
															...
															<tbody id="filterBankReceiptVoucherList"></tbody>
														</table>
													</div>
												</div>
											</div>
	...
	<script !src="">
		function DeleteRvActivity(RvId,RvNo,UserName,DeleteDate,DeleteTime,ActivityType)
		{
			if (confirm('Are you sure you want to delete this thing into the Software?'))
			{
				var m = '<?php echo $_GET['m'];?>';
				$.ajax({
					url: '<?php echo url('/')?>/fdc/DeleteRvActivity',
					type: "GET",
					data: { RvId:RvId,RvNo:RvNo,UserName:UserName,DeleteDate:DeleteDate,
