                                                ...
                                                <table id="myTable" class="table table-bordered sf-table-list">
                                                    ...
                                                    @foreach($accounts as $key => $y)
                                                        ...
                                                        @if($y->type==4)style="background-color:lightgray"  @endif
                                                            ...
                                                            <td>{{ $y->code.'==='.$y->operational}}</td>
                                                            <td>
                                                                <?php
                                                                    $Code = str_replace('-','',$y->code);
                                                                    $PCode = str_replace('-','',$y->parent_code);
                                                                    echo $PCode.'----'.$Code;

                                                                ?>

                                                                <button type="button" class="btn btn-xs btn-primary" style="width: 67px; display: none" id="BtnDown"><i class="fa fa-arrow-down" aria-hidden="true"></i></button>
