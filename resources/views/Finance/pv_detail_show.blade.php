...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        <?php echo FinanceHelper::displayApproveDeleteRepostButton($m,$row->pv_status,$row->status,$row->pv_no,'pv_no','pv_status','status');?>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <label style="float: left">
                        <input  onclick="ShowAllTaxes('{{$row->id}}')" type="checkbox" id="Taxes">Show Taxes
                    </label>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive">
                                <table  class="table table-bordered table-striped table-condensed tableMargin">
                                    <thead>
                                    <tr>
                                        <th class="text-center">Register In SRB</th>
                                        <th class="text-center" >Advertisment , Renting , Auction , Intencity Transport Or Carriage Of Goods</th>
