						...
						<div class="well">
							...
							<div class="row">
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-right">
									<input type="button" value="View Range Wise Data Filter" class="btn btn-primary" onclick="GetCpvsDateAndAccontWise();" style="margin-top: 32px;" />
								</div>
							</div>
												...
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
														<div class="table-responsive">
															...
															<table class="table table-bordered sf-table-list" id="TableExportToCsv1">
																<thead>
	...
	<script !src="">
		function ExportToExcel(type, fn, dl) {
			...
			return dl ?
					...
					XLSX.writeFile(wb, fn || ('C.P.V <?php echo date('Y-m-d')?>.' + (type || 'xlsx')));
		}
	</script>
