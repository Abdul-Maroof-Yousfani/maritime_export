			...
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                        <?php echo CommonHelper::displayPrintButtonInBlade('printCashReceiptVoucherList','','1');?>
                        <?php echo CommonHelper::displayExportButton('cashReceiptVoucherList','','1')?>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="well">
							...
							<div class="lineHeight">&nbsp;</div>
							<div id="printCashReceiptVoucherList">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="panel">
										<div class="panel-body">
											...
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="table-responsive">
														<table class="table table-bordered sf-table-list" id="cashReceiptVoucherList">
   															<thead>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
									<img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(200)->generate('View Cash Receipt Voucher List'))!!} ">
								</div>
							</div>
							</div>
						</div>
