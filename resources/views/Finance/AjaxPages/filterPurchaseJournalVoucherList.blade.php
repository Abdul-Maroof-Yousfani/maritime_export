...
$accounts = $accounts::orderBy('level1', 'ASC')
    ...
    ->get();
$jvs = DB::table('jvs')
    ->select('jvs.id','jvs.jv_no','jvs.slip_no','jvs.jv_date','jvs.jv_status','jvs.status','jvs.voucherType','jv_data.acc_id')
...
<tr>
    ...
    <td class="text-center hidden-print"><a onclick="showDetailModelOneParamerter('fdc/viewJournalVoucherDetail','<?php echo $row1->id;?>','View Journal Voucher Detail')" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-eye-open"> V</span></a></td>
</tr>
<?php
}
?>
<tr>
    ...
    <th class="text-center">Total Purchase Journal Voucher Amount</th>
