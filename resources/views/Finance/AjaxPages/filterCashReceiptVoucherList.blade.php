...
$accounts = $accounts::orderBy('level1', 'ASC')
    ...
    ->get();
$rvs = DB::table('rvs')
    ->select('rvs.rv_no','rvs.id','rvs.rv_date','rvs.rv_status','rvs.slip_no','rvs.status','rv_data.acc_id')
...
<tr>
    ...
    <td class="text-center hidden-print"> <a onclick="showDetailModelOneParamerter('fdc/viewCashReceiptVoucherDetail','<?php echo $row1->id;?>','View Cash R.V Detail')" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-eye-open"> V</span></a> <?php FinanceHelper::changeActionButtons($m,$row1->rv_status,$row1->status,$row1->id,'rv_no','rv_status','status','finance/editCashReceiptVoucherForm','Cash R.V. Edit Detail Form');?></td>
</tr>
<?php
}
?>
<tr>
    ...
    <th class="text-center">Total Cash Receipt Voucher Amount</th>
