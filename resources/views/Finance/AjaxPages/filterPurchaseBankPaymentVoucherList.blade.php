...
$accounts = $accounts::orderBy('level1', 'ASC')
    ...
    ->get();
$pvs = DB::table('pvs')
    ->select('pvs.id','pvs.pv_no','pvs.pv_date','pvs.pv_status','pvs.status','pv_data.acc_id','pvs.cheque_no','pvs.slip_no','pvs.cheque_date')
...
<tr>
    ...
    <td class="text-center hidden-print"><a onclick="showDetailModelOneParamerter('fdc/viewBankPaymentVoucherDetail','<?php echo $row1->id;?>','View Bank P.V Detail')" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-eye-open"> V</span></a></td>
</tr>
<?php
}
?>
<tr>
    ...
    <th class="text-center">Total Purchase Bank Paymant Voucher Amount</th>
    <th colspan="4" class="text-center">X <------> X</th>
