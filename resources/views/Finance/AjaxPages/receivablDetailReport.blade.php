                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="table-responsive">
                                            <table  id="EmpExitInterviewList" class="table table-bordered sf-table-list">
                                                <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left" style="font-size: large;font-weight: bolder">
                                                            <a target="_blank" href="<?php echo URL('finance/viewLedgerReport?AccId='.$Fil->acc_id.'&&FromDate='.$from.'&&ToDate='.$to.'&&m='.$m)?>">
                                                                <?php echo $Fil->client_name.'id='.$Fil->paid_to.'Type='.$Fil->paid_to_type?>

                                                        </a>
                                                    </td>
                                                    <td style="font-size: large;font-weight: bolder" class="text-right">
                                                ...
                                                <?php
                                                        $counter=1;
                                                            $Detail= CommonHelper::get_branch($Fil->id);
                                                            ...
                                                            <tr title="{{$row->id}}">
                                                                ...
                                                                <td>
                                                                    <?php   $amount=CommonHelper::get_ledger_amount_paid_to($Fil->acc_code,$m,1,0,$from,$to,$row->paid_to,5);
                                                                    if ($amount<0):
                                                                        $amount=$amount*-1;
                                                                        $amount=number_format($amount,2);
                                                                        $amount='('.$amount.')';
