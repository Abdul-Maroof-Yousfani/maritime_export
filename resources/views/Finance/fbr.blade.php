<div class="container-fluid">
    ...
    <input type="hidden" id="fbr_amount" value="{{$array[0]}}">
    <input type="hidden" id="fbr_sales_tax" value="{{$array[1]}}">
    <div class="well">-
        <div class="row">
...
<blockquote style="display: none;color: red" id="fbr_html" cite="">
    ...
    function sindh_sales_tax_calculation()
    {
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('.perc5').html('Sales Tax '+response[0]);
                ...
                {
                    apply_amount= $('#fbr_sales_tax').val();
