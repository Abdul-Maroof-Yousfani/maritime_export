...
<div class="container-fluid">
    ...
    <input type="hidden" id="pra_sales_tax" value="">
...
//alert(registerd); alert(advertisment); alert(company); alert(active_pra);
        ...
        $.ajax({
           ...
           $('#pra_html').html(txt+' '+response[0]);
                $('.perc13').text('PRA Withholding '+ txt+' '+response[0]);
                ...
                $('#tax11').fadeIn(500);
                $('#c_amount_1_13').val(cal_amount);
                $('#account_id_1_13').val(response[4]).trigger('change');
