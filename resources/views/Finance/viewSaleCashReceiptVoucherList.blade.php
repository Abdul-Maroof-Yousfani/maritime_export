            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                        <?php echo CommonHelper::displayPrintButtonInBlade('printSaleCashReceiptVoucherList','','1');?>
                        <?php echo CommonHelper::displayExportButton('saleCashReceiptVoucherList','','1')?>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <span class="subHeadingLabelClass">View Sale Cash Receipt Voucher List</span>
                                </div>
                            </div>
                            <div class="lineHeight">&nbsp;</div>
                            <input type="hidden" name="functionName" id="functionName" value="fdc/filterSaleCashReceiptVoucherList" readonly="readonly" class="form-control" />
                            <input type="hidden" name="tbodyId" id="tbodyId" value="filterSaleCashReceiptVoucherList" readonly="readonly" class="form-control" />
                            ...
                            <div class="lineHeight">&nbsp;</div>
                            <div id="printSaleCashReceiptVoucherList">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered sf-table-list" id="saleCashReceiptVoucherList">
                                                            <thead>
                                                            ...
                                                            <tbody id="filterSaleCashReceiptVoucherList"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right hidden qrCodeDiv">
                                    <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(200)->generate('View Sale Cash Receipt Voucher List'))!!} ">
                                </div>
                            </div>
                            </div>
                        </div>
