            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="well_N">
                    <div class="dp_sdw">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">Create Scrap Declration</span>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                <input type="date" max="<?php echo date('Y-m-d'); ?>" name="sd_date" id="sd_date_1"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <textarea class="form-control" name="sd_remarks" id="sd_remarks_1" cols="5" rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div class="lineHeight">&nbsp;</div>
                                        <div class="row">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody id="AppnedHtml">
                                                            <tr class="cnt" id="removeSection1">
                                                                <td>
                                                                    <select style="width:200px!important;" name="category_id[]" id="category_id_1" class="form-control requiredField select2">
                                                                ...
                                                                <td>
                                                                    <select style="width:200px!important;" onchange="get_item_name(1);" name="item[]" id="item_id_1" class="form-control requiredField select2 item_id">
                                                                ...
                                                                <td><input style="width:200px!important;" type="text"
                                                                    ...
                                                                    id="item_code_1"  value="">
                                                                </td>
                                                                <td><input style="width:200px!important;" type="text"
                                                                    class="form-control " name="item_desc[]"
                                                                    id="item_desc_1"  value="">
                                                                </td>
                                                                <td><input style="width:200px!important;" type="text"
