...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
        <?php echo StoreHelper::displayApproveDeleteRepostButtonPurchaseRequestSale($m,$row->purchase_request_status,$row->status,$row->purchase_request_no,'purchase_request_no','purchase_request_status','status','purchase_request','purchase_request_data');?>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center"
                             style="font-size: 20px !important; font-style: inherit;
    								font-family: -webkit-body; font-weight: bold;">
                            <?php StoreHelper::checkVoucherStatus($row->purchase_request_status,$row->status);?>
                        </div>
                    </div>
                </div>
