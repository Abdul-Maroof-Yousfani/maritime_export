...
.table-responsive{scrollbar-width:thin;scrollbar-color:#333 #ccc;overflow:auto;}
html .content{margin-left:0px !important;}




.table-container{position:relative;max-height:400px;overflow-x:auto;overflow-y:auto;}
.table-container::-webkit-scrollbar{height:8px;}
.table-container::-webkit-scrollbar-thumb{background-color:#333;/* Scrollbar thumb color */
}
.table-container::-webkit-scrollbar-track{background-color:#ccc;/* Scrollbar track color */
}
.table-container .fixed-scrollbar{position:sticky;bottom:0;background-color:white;/* Background to cover table content */
 z-index:10;/* Ensures the scrollbar is on top of content */
 width:100%;}
...
<div class="well_N">
                        ...
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <span class="subHeadingLabelClass">Stock Report</span>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    ...
                                                    <input id="to_date" required="required" min="{{$financial_year[0]}}" max="{{$financial_year[1]}}" name="from_date" class="date1 form-control" type="date" value="{{date('Y-m-d')}}" />
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <div class="form-group ">
                                                        <label for="email">Category </label>
                                                        <select onchange="get_sub_item('category_id1')" name="category" multiple id="category_id1"
                                            ...
                                            <div id="printBankReceiptVoucherList">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div id="filterBookDayList" class="table-responsive table-container fixed-scrollbar"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script !src="">
        ...
        //             type: 'base64'
        //         }) :
        //         XLSX.writeFile(wb, fn || ('Stock Report <?php echo date('Y-m-d'); ?>.' + (type || 'xlsx')));
        // }
    </script>
    <script>
