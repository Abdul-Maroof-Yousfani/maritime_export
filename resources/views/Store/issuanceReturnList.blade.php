...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Issuance Return List</span>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="row">
                                                                ...
                                                                {{-- <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                                    <label class="sf-label">Department / Sub
                                                                        Department</label>
                                                                    <select class="form-control requiredField select2"
                                                                        name="department" id="department">
                                                                        <option value="0">Select Department</option>
                                                                        @foreach (CommonHelper::get_all_department_po($m) as $key => $y)
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input type="button" value="Submit"
                                                                        ...
                                                                        onclick="getIssuanceReturnData();" style="margin-top: 33px"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function getIssuanceReturnData() {
            ...
            var issuance_status = $('#issuance_status').val() || 0;
            $.ajax({
                url: "{{ url('/pdc/issuanceReturnDataFilter') }}",
                data: {
                    FromDate: FromDate,
                    ToDate: ToDate,
        ...
        function delete_issue(voucher_no) {
            if (confirm('Are You Sure ? You want to delete this recored...!')) {
                $.ajax({
                    url: "{{url('/stdc/delete_issue_return')}}",
                    type: 'Get',
                    data: {
                        voucher_no: voucher_no
                    },
