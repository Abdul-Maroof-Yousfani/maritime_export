            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <?php echo Form::open(array('url' => 'pad/add_internal_consum?m='.$m.'','id'=>'addPurchaseReturnDetail','class'=>'stop'));?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered sf-table-list">
                                                ...
                                                <tr class="text-center AutoNo">
                                                    <td>
                                                        <input type="text" name="item_idd[]" id="item_1" class="form-control sam_jass requiredField">
                                                        <input type="hidden" class="requiredField requiredField" name="item_id[]" id="sub_1">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><select onchange="get_stock_qty(this.id,1)" class="form-control requiredField" name="batch_code[]" id="batch_code1">
                                                    ...
                                                    <td>
                                                        <select name="warehouse_to[]" id="warehouse_to1" class="form-control requiredField" style="width: 180px;">
                                                            ...
                                                            <option  value="<?php echo $Fil->id?>" @if($Fil->id==847) selected @endif><?php echo $Fil->name?></option>
                                                            <?php endforeach;?>
                                                        </select>
                                                    </td>
    ...
    <script>
        ...
        function AddMoreRows()
        {
            ...
            $('#AppendHtml').append('<tr class="text-center AutoNo" id="RemoveRow'+Counter+'">' +
                    ...
                    '<option value="">Select Warehouse</option>'+
                    <?php foreach(CommonHelper::get_all_account() as $Fil):?>
                    "<option @if($Fil->id==847) selected @endif value='<?php echo $Fil->id?>'><?php echo $Fil->name?></option>"+
                    <?php endforeach;?>
                    '</select>' +
                    '</td>' +
                    '<td><textarea name="des[]"></textarea></td>'+
