                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <span class="subHeadingLabelClass">Create Purchase Request For Sale</span>
                                </div>
                            </div>
                            <div class="lineHeight">&nbsp;</div>
                            <input type="hidden" name="functionName" id="functionName" value="stdc/filterApproveDemandListandCreatePurchaseRequestSale" readonly="readonly" class="form-control" />
                            <input type="hidden" name="divId" id="divId" value="filterApproveDemandListandCreatePurchaseRequestSale" readonly="readonly" class="form-control" />
                            ...
                            <div class="lineHeight">&nbsp;</div>
                            <div id="filterApproveDemandListandCreatePurchaseRequestSale"></div>
                        </div>
                    </div>
                </div>
            </div>
