                                                        ...
                                                        <table class="table table-bordered sf-table-list">
                                                            ...
                                                            <tr class="text-center AutoNo" id="RemoveRow<?php echo $Couter?>">
                                                                <td>
                                                                    ...
                                                                    <select name="item_id[]" class="form-control select2" id="sub_<?php echo $Couter?>">
                                                                        <option value="0">Select item</option>
                                                                        @foreach (CommonHelper::get_all_subitem() as $item)
                                                                            <option @if($Fil->item_id == $item->id) selected @endif value="{{$item->id}}">{{$item->item_code.' - '. $item->sub_ic}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select onchange="get_stock(this.id,'<?php echo $Couter?>','No')" name="warehouse_from[]" id="warehouse_from<?php echo $Couter?>" class="form-control requiredField" style="width: 180px;">
                                                                        ...
                                                                        <?php foreach(CommonHelper::get_users_warehouse() as $FFil):?>
                                                                ...
                                                                <td>
                                                                    <select name="warehouse_to[]" id="warehouse_to<?php echo $Couter?>" class="form-control requiredField" style="width: 180px;">
                                                                        <option value="">Select Warehouse</option>
                                                                        <?php foreach(CommonHelper::get_users_warehouse() as $TFil):?>
    ...
    <script>
        ...
        function AddMoreRows()
        {
            ...
            $('#AppendHtml').append('<tr class="text-center AutoNo" id="RemoveRow'+Counter+'">' +
                    ...
                    '<input type="hidden" name="item_idd[]" id="item_'+Counter+'" class="form-control sam_jass requiredField" value="">'+
                    '<select name="item_id[]" class="form-control select2" id="sub_'+Counter+'">'+
                    '    <option value="0">Select item</option>'+
                    '    @foreach (CommonHelper::get_all_subitem() as $item)'+
                    ...
                    '<option value="">Select Warehouse</option>'+
                    '@foreach(CommonHelper::get_users_warehouse() as $Fil)'+
                    ...
                    '<option value="">Select Warehouse</option>'+
                    <?php foreach(CommonHelper::get_users_warehouse() as $Fil):?>
                    '<option value="<?php echo $Fil->id?>"><?php echo $Fil->name?></option>'+
                    <?php endforeach;?>
                    '</select>' +
                    '</td>' +
