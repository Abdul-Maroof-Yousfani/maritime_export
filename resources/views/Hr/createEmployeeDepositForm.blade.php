                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="well">
                            ...
                            <div class="row">
                                <?php echo Form::open(array('url' => 'had/addEmployeeDepositDetail'));?>
                                                ...
                                                <div class="get_clone">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input type="month" name="to_be_deduct_on_date" id="to_be_deduct_on_date" value="" class="form-control requiredField count_rows" required />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input type="text" name="deposit_name" id="deposit_name" value="" class="form-control requiredField count_rows" required />
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <label class="sf-label">Deposit Amount</label>
                                                            <span class="rflabelsteric"><strong>*</strong></span>
                                                            <input type="number" name="deposit_amount" id="deposit_amount" value="" class="form-control requiredField count_rows" required />
                                                        </div>
                                                    </div>
