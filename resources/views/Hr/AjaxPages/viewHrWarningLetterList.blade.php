                    ...
                    <table class="table table-bordered sf-table-list table-hover" id="EmployIdCardRequestList">
                        @if($hr_warning_letter->count() > 0)
                            ...
                            @foreach($hr_warning_letter->get() as  $row)
                                <?php
                                   $getActiveProjectId = HrHelper::getActiveProjectId($m,$row->emr_no);
                                  ?>
                                <tr>
                                    ...
                                    <td class="text-center">{{ HrHelper::getProjectName('employee_projects','project_name',$getActiveProjectId)}}</td>
