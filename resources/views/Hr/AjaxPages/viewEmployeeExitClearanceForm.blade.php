...
$designation_name = HrHelper::getMasterTableValueByIdAndColumn($m, 'designation', 'designation_name', $employee->designation_id, 'id');
$location = HrHelper::getMasterTableValueByIdAndColumn($m, 'locations', 'employee_location', $employee->branch_id, 'id');
...
<style>
    ...
    input[type="radio"],[type="checkbox"]{ width:30px;
        height:20px;
    }
...
@if($count==1)
    <input type="hidden" name="emp_id" value="<?php echo $exit_employee_data->emr_no; ?>">
@endif
...
<div class="row">
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
        <div class="form-group">
            ...
            <input readonly name="employee_location" id="employee_location" type="text" value="{{ $location }}" class="form-control">
        </div>
    </div>
