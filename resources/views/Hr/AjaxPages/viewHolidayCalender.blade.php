...
if(empty($bookingRecordSetting)){
    ...
    $displayStartDate = date('d-m-Y', strtotime($currentDate. ' - '.$displayStartDays.' days'));
    $displayEndDate = date('d-m-Y', strtotime($currentDate. ' + '.$displayEndDays.' days'));
}
        ...
        if($i < $startday) echo "<td></td>\n";
            ...
            if(in_array($dayinnumber, $checkVars['bookings'])){
                ...
                if(empty($bookingRecordSetting)){
                    ...
                    $displayStartDate = date('d-m-Y', strtotime($currentDate. ' - '.$displayStartDays.' days'));
                    $displayEndDate = date('d-m-Y', strtotime($currentDate. ' + '.$displayEndDays.' days'));
                    $displayDatesRights = check_in_range($displayStartDate, $displayEndDate, date("d-m-Y", strtotime($dayinnumber)));
                }
