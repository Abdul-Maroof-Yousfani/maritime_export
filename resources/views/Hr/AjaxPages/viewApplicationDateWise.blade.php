...
//print_r($leave_application_request_list); die();
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="table-responsive">
                ...
                <table class="table table-bordered sf-table-list">
                    ...
                    <?php $emp_name = $value1['emp_name']; ?>
                        <tr>
                            <td class="text-center">{{ $counter2++ }}</td>
                            <td class="text-center">{{ $value1['acc_no'] }}</td>
                            <td class="text-center">{{ $value1['emp_name'] }}</td>
                            ...
                            <td class="text-center" style="background-color: #FFC0CB">{{ $value1['late'] }}</td>
                ...
                <table class="table table-bordered sf-table-list" id="LeaveApplicationRequestList">
                    ...
                    @foreach($leave_application_request_list as $value)
                        <tr>
                            ...
                            <td class="text-center">{{ ucfirst($emp_name) }}</td>
                            ...
                            <td class="text-center hidden-print">
                                <button onclick="LeaveApplicationRequestDetail('<?=$value->id?>','<?=$value->leave_day_type?>','<?=$leave_type_name?>','<?=$value->emp_id?>','<?=$value->company_id?>')" class="btn btn-xs btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample<?=$value->id?>" aria-expanded="false" aria-controls="collapseExample">
