...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="well">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <span class="subHeadingLabelClass">Create Employee Transfer Form</span>
                            </div>
                        </div>
                        <div class="lineHeight">&nbsp;</div>
                        <div class="row">
                            <?php echo Form::open(array('url' => 'had/addEmployeeTransferDetail','id'=>'employeeLocationForm',"enctype"=>"multipart/form-data"));?>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <select class="form-control requiredField" id="location_id" name="location_id" required>
                                                    ...
                                                    @foreach($location as $key5 => $value5)
                                                        <option value="{{ $value5->id}}">{{ $value5->employee_location}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="row" style="background-color: gainsboro">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
                                                <input type="checkbox" name="location_check" id="location_check" value="1">
                                            </div>
                                        </div>
                                        <div class="row">&nbsp;</div>
                                        <div class="row">
                                            <div id="different-package" style="display: none;">
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    <label class="sf-label">Grade :</label>
                                                    <span class="rflabelsteric"><strong>*</strong></span>
                                                    <select class="form-control" id="grade_id" name="grade_id">
                                                        <option value="">Select Grade</option>
                                                        @foreach($employee_grades as $key4 => $v3)
                                                            <option value="{{ $v3->id}}">{{ $v3->employee_grade_type}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    ...
                                                    <span class="rflabelsteric"><strong>*</strong></span>
                                                    <input type="text" name="increment" id="increment" onkeyup="changeSalary()" value="" class="form-control"/>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <label class="sf-label">Salary :</label>
                                                    <span class="rflabelsteric"><strong>*</strong></span>
                                                    <input type="number" name="salary" id="salary" value="" class="form-control" readonly />
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    <label class="sf-label">Promotion Date :</label>
                                                    <span class="rflabelsteric"><strong>*</strong></span>
                                                    <input type="date" name="promotion_date" id="promotion_date" value="" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">&nbsp;</div>
                                        <div class="row" style="background-color: gainsboro">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
                                                <input type="checkbox" name="transfer_project_check" id="transfer_project_check" value="1">
                                            </div>
                                        </div>
                                        <div class="row">&nbsp;</div>
                                        <div class="row">
                                            <div id="transfer_project_package" style="display: none;">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label class="sf-label">Transfer Project :</label>
                                                    <select class="form-control" id="transfer_project_id" name="transfer_project_id">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="date" name="transfer_date" id="transfer_date" value="" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $('#emr_no').on('change', function() {
            ...
            if(emr_no) {
                $.ajax({
                    url: '<?php echo url('/')?>/hdc/viewEmployeePreviousTransferDetail',
                    type: "GET",
        ...
        $("#transfer_project_check").click(function(){
            if($(this).is(":checked") == true){
                $("#transfer_project_package").show();
                $('#transfer_project_id').addClass('requiredField');
                $('#transfer_date').addClass('requiredField');
                $('#transfer_project_id').select2();
            }
            else{
                $("#transfer_project_package").hide();
                $('#transfer_project_id').removeClass('requiredField');
                $('#transfer_date').removeClass('requiredField');
            }
        });
