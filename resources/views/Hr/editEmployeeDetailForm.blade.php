...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="well">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="emp_code_hidden" value="<?=$employee_detail->emp_code?>">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input type="number" name="emp_code_1" id="emp_code_1" value="<?=$employee_detail->emp_code?>" onkeyup="checkEmrNoExist()" class="form-control requiredField" readonly>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <a onclick="insertMasterTableRecord('hdc/viewMasterTableForm','Add Departments','department','department_name','department_id','<?php echo $m; ?>')"><label class="sf-label pointer">Department / Sub Department</label></a>
                                        <select class="form-control requiredField emp_department_id" name="emp_department_id_1" id="department_id_1" onChange="departmentDependentDesignation()">
                                            <option value="">Select Department</option>
                                            @foreach($departments as $key => $y)
                                                <option @if($y->id == $employee_detail->emp_department_id ) selected @endif value="{{ $y->id}}">{{ $y->department_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <a onclick="insertMasterTableRecord('hdc/viewMasterTableForm','Add Designation','designation','designation_name','designation','<?php echo $m; ?>')"><label class="pointer sf-label">Designation</label></a>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <select class="form-control requiredField" id="designation_1" name="designation_1" >
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <a onclick="insertMasterTableRecord('hdc/viewMasterTableForm','Add Region','regions','employee_region','region_id','<?php echo $m; ?>')"><label class="pointer sf-label">Region</label></a>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <select class="form-control requiredField" id="region_id_1" name="region_id_1" onchange="locationDependentRegion()">
                                            <option value="">Select Region</option>
                                            @foreach($employee_regions as $v1)
                                                <option @if($employee_detail->region_id == $v1->id) selected @endif  value="{{ $v1->id }}">{{ $v1->employee_region}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <a onclick="insertMasterTableRecord('hdc/viewMasterTableForm','Add Location','locations','employee_location','branch_id','<?php echo $m; ?>')"><label class="pointer sf-label">Location / Branch</label></a>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <select class="form-control requiredField" id="branch_id_1" name="branch_id_1">
                                            <option value="">Select Location / Branch</option>
                                            @foreach($employee_locations as $v2)
                                                <option @if($employee_detail->branch_id == $v2->id) selected @endif  value="{{ $v2->id}}">{{ $v2->employee_location}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="text" class="form-control requiredField" placeholder="CNIC Number" name="cnic_1" id="cnic_1" value="<?=$employee_detail->emp_cnic ?>" />
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <label class="sf-label">CNIC Expiry Date</label>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="date" class="form-control requiredField" name="cnic_expiry_date_1" id="cnic_expiry_date_1" value="<?=$employee_detail->emp_cnic_expiry_date ?>" />
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <label class="sf-label">Life Time Validity</label>
                                        <input @if($employee_detail->life_time_cnic == 1 ) checked @endif type="checkbox" class="form-control" name="life_time_cnic_1" id="life_time_cnic_1" value="1" />
                                    </div>
                                    @if($employee_cnic_copy->count() > 0)
                                        <div id="cnic_div_hide">
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <label>&nbsp</label><br>
                                                <label class="pointer" id="cnic_check" style="color: green; margin-right: 10px;">Change / Edit CNIC copy:</label>
                                                <a onclick="showMasterTableEditModel('hdc/viewEmployeeCnicCopy','<?php echo $employee_detail->id.'|'.$employee_detail->emp_code;?>','View Employee CNIC Copy','<?php echo $m; ?>')" class=" btn btn-info btn-xs">View</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="display: none" id="cnic_div_show">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <select class="form-control" name="marital_status_1" id="marital_status_1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Province" name="province_1" id="province_1" value="<?=$employee_detail->province ?>" />
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Cell No / Mobile No</label>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="text" class="form-control requiredField" placeholder="Cell No / Mobile No" name="contact_no_1" id="contact_no_1" value="<?=$employee_detail->emp_contact_no?>" min="11"/>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Home No# </label>
                                        <input type="text" class="form-control" placeholder="Home No" name="contact_home_1" id="contact_home_1" value="<?=$employee_detail->contact_home?>" min="11" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Office No" name="contact_office_1" id="contact_office_1" value="<?=$employee_detail->contact_office?>" min="11"/>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Emergency No#</label>
                                        <input type="text" class="form-control" placeholder="Emergency No" name="emergency_no_1" id="emergency_no_1" value="<?=$employee_detail->emergency_no?>" min="11"/>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="sf-label">Joining Salary</label>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="number" step="any" class="form-control requiredField" placeholder="Joining Salary" name="emp_joining_salary_1" id="emp_joining_salary_1" value="<?=$employee_detail->emp_joining_salary?>" />
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <label class="sf-label">Current Salary</label>
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input type="number" step="any" class="form-control requiredField" placeholder="Current Salary" name="salary_1" id="salary_1" value="<?=$employee_detail->emp_salary?>" />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										...
										<select class="form-control" name="working_hours_policy_id_1" id="working_hours_policy_id_1">
											<option @if($employee_detail->working_hours_policy_id == 0) selected @endif value="0">--</option>
											<option @if($employee_detail->working_hours_policy_id == 1) selected @endif  value="1">MFM (Salary / 30 / 12)</option>
											<option @if($employee_detail->working_hours_policy_id == 2) selected @endif  value="2">Other (Salary / 210)*2</option>
										</select>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    @if($employee_eobi_copy->count() > 0)
                                        <div id="eobi_div_hide">
                                            ...
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                                <label>&nbsp</label><br>
                                                <a onclick="showMasterTableEditModel('hdc/viewEmployeeEobiCopy','<?php echo $employee_detail->id.'|'.$employee_detail->emp_code;?>','View Employee EOBI Copy','<?php echo $m; ?>')" class=" btn btn-info btn-xs">View</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="display: none" id="eobi_div_show">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Passport No" name="passport_no_1" id="passport_no_1" value="<?=$employee_detail->passport_no ?>" />
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label class="sf-label">Valid From</label>
                                        <input type="date" class="form-control" placeholder="Valid From" name="passport_valid_from_1" id="passport_valid_from_1" value="<?=$employee_detail->passport_valid_from ?>" />
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label class="sf-label">Valid To</label>
                                        <input type="date" class="form-control" placeholder="Valid To" name="passport_valid_to_1" id="passport_valid_to_1" value="<?=$employee_detail->passport_valid_to ?>" />
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Driving License No" name="driving_license_no_1" id="driving_license_no_1" value="<?=$employee_detail->driving_license_no ?>" />
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label class="sf-label">Valid From</label>
                                        <input type="date" class="form-control" placeholder="Valid From" name="driving_license_valid_from_1" id="driving_license_valid_from_1" value="<?=$employee_detail->driving_license_valid_from ?>" />
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label class="sf-label">Valid To</label>
                                        <input type="date" class="form-control" placeholder="Valid To" name="driving_license_valid_to_1" id="driving_license_valid_to_1" value="<?=$employee_detail->driving_license_valid_to ?>" />
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><br>
                                        ...
                                        <input type="hidden" value="<?=$employee_detail->transport_particular?>" id="hidden_transport_particulars_1">
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="transport_particular_area_1">
                                        @if($employee_detail->transport_owned == 'Yes')
                                            <label class="sf-label">Particulars</label>'
                                            <span class="rflabelsteric"><strong>*</strong></span>
                                            <input type="text" class="form-control requiredField" placeholder="Particulars" name="transport_particulars_1" id="transport_particulars_1" value="<?=$employee_detail->transport_particular?>" />
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="row" id="family_data_area_1">
                                    @if($employee_family_detail->count() > 0)
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="table-responsive" id="family_append_area_1">
                                                @foreach($employee_family_detail->get() as $employeeFamilyData)
                                                    ...
                                                    <table class="table table-bordered sf-table-list get_rows3 remove_area3_<?=$employeeFamilyData->id?>" id="get_clone3">
                                                        <thead>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-control requiredField" name="family_name_<?=$employeeFamilyData->id?>" id="family_name_<?=$employeeFamilyData->id?>" value="<?=$employeeFamilyData->family_name?>" required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Relation<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input class="form-control requiredField" name="family_relation_<?=$employeeFamilyData->id?>"  id="family_relation_<?=$employeeFamilyData->id?>" value="<?=$employeeFamilyData->family_relation?>" required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Age<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input type="number" class="form-control requiredField" name="family_age_<?=$employeeFamilyData->id?>" id="family_age_<?=$employeeFamilyData->id?>" value="<?=$employeeFamilyData->family_age?>" required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Designation / Occuption<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input class="form-control requiredField" name="family_occupation_<?=$employeeFamilyData->id?>" id="family_occupation_<?=$employeeFamilyData->id?>" value="<?=$employeeFamilyData->family_occupation?>" required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Organization<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input class="form-control requiredField" name="family_organization_<?=$employeeFamilyData->id?>" id="family_organization_<?=$employeeFamilyData->id?>" value="<?=$employeeFamilyData->family_organization?>" required>
                                                        </td>
                                                        </thead>
                                                    </table>

                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                                        <button type="button" onclick="removeFamilyDataSection('<?=$employeeFamilyData->id?>')" class="btn btn-xs btn-danger remove_area3_<?=$employeeFamilyData->id?>">Remove</button>
                                                    </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                            <button type="button" class="btn btn-xs btn-primary" id="addMoreFamilyData">Add More Family Data</button>
                                        </div>
                                        <script>
                                            $("#addMoreFamilyData").click(function(e){
                                                ...
                                                $("#family_append_area_1").append('<table class="table table-bordered sf-table-list remove_area3_'+form_rows_count+' get_rows3" id="">' +
                                                    '<thead><th>Name<span class="rflabelsteric"><strong>*</strong></span>' +
                                                    '<input type="hidden" name="family_data[]" value="'+form_rows_count+'"></th>' +
                                ...
                                <div class="row" id="bank_account_area_1">
                                    @if($employee_bank_detail->count() > 0 )
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <span class="rflabelsteric"><strong>*</strong></span>
                                            <input type="text" class="form-control requiredField" placeholder="Title Of Account" name="account_title" id="account_title" value="<?=$employee_bank_detail->value('account_title')?>" />
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label class="sf-label">Bank Name</label><span class="rflabelsteric"><strong>*</strong></span>
                                            <input type="text" class="form-control requiredField" placeholder="Bank Name" name="bank_name" id="bank_name" value="<?=$employee_bank_detail->value('bank_name')?>" />
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <label class="sf-label">Account No</label>
                                            <span class="rflabelsteric"><strong>*</strong></span>
                                            <input type="text" class="form-control requiredField" placeholder="Account No" name="account_no" id="account_no" value="<?=$employee_bank_detail->value('account_no')?>" />
                                        </div>
                                                    ...
                                                    @foreach($employee_educational_detail->get() as $employee_educational_value)
                                                        <tr class="get_rows_education" id="remove_area_<?=$employee_educational_value->id?>">
                                                            ...
                                                            <td><input type="hidden" name="qualificationSection[]">
                                                                <select style="width:300px;" id="degree_type_<?=$employee_educational_value->id?>" class="form-control requiredField get_clone_1" name="degree_type_<?=$employee_educational_value->id?>"><option value="">Select</option>
                                                            ...
                                                            <td class="text-center"><input name="major_subjects_<?=$employee_educational_value->id?>" type="text" class="form-control requiredField" id="major_subjects_<?=$employee_educational_value->id?>" value="<?=$employee_educational_value->major_subjects?>"></td>
                                                            <td class="text-center">
                                                                <button onclick='removeQualificationSection("<?=$employee_educational_value->id?>")'  type='button'class='btn btn-xs btn-danger'>Remove</button>
                                                                <script>
                                                ...
                                                <table class="table table-bordered sf-table-list" >
                                                    ...
                                                    @foreach($employee_language_proficiency->get() as $language_proficiency_detail)
                                                        <tr class="get_rows7" id="remove_area7_<?=$language_proficiency_detail->id?>">
                                                            ...
                                                            <td class="text-center">
                                                                <button onclick='removeLanguageProficiencySection("<?=$language_proficiency_detail->id?>")' type='button'class='btn btn-xs btn-danger'>Remove</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
                                        ...
                                        <script>
                                            $("#addMoreLanguage").click(function(e){
                                                ...
                                                $("#insert_clone7").append("<tr class='get_rows7' id='remove_area7_"+form_rows_count+"' ><td class='text-center'>" +
                                                    ...
                                                    "<td class='text-center'><b>Good : <input type='radio' name='reading_skills_"+form_rows_count+"' value='Good'></b>" +
                                                    ...
                                                    "<td class='text-center'><b>Good : <input type='radio' name='writing_skills_"+form_rows_count+"' value='Good'></b>" +
                                                    ...
                                                    "<td class='text-center'><b>Good : <input type='radio' name='speaking_skills_"+form_rows_count+"' value='Good'></b>" +
                                    ...
                                    @if($employee_health_data->count() > 0)
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered sf-table-list" >
                                                    <thead>
                                                    <th class="text-center col-sm-1">S.No</th>
                                                    <th>Health Type<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    ...
                                                    @foreach($employee_health_data->get() as $employee_health_value)
                                                        <tr class="get_rows8 remove_area8_<?=$employee_health_value->id?>">
                                                            ...
                                                            <td>
                                                                <select style="width:300px;" class="form-control" name="health_type_<?=$employee_health_value->id?>" id="health_type_<?=$employee_health_value->id?>" required>
                                                            ...
                                                            <td class="text-center">
                                                                <select class="form-control" id="health_check_<?=$employee_health_value->id?>" name="health_check_<?=$employee_health_value->id?>" required>
                                                            ...
                                                            <td class="text-center">
                                                                <button type="button" onclick="removeHealthDetailsSection('<?=$employee_health_value->id?>')" class="btn btn-xs btn-danger remove_area8_<?=$employee_health_value->id?>">Remove</button>
                                                            </td>
                                                        </tr>
                                                        <script>
                                                            $(document).ready(function () {
                                        ...
                                        <script>
                                            ...
                                            $("#addMoreHealth").click(function(e){
                                                ...
                                                var clone_health_type = $("#health_type_<?=$employee_health_value->id?>").html();
                                                var clone_health_check = $("#health_check_<?=$employee_health_value->id?>").html();
                                                ...
                                                $("#insert_clone8").append('<tr class="remove_area8_'+form_rows_count+' get_rows8" id="">' +
                                                    ...
                                                    '<td><select style="width:300px class="form-control" name="health_type_'+form_rows_count+'" id="health_type_'+form_rows_count+'" required>'+clone_health_type+'</select></td>' +
                                    ...
                                    @if($employee_activity_data->count() > 0 )
                                        <div id="get_clone4">
                                            @foreach($employee_activity_data->get() as $employee_activity_detail )
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 get_rows4 remove_area4_<?=$employee_activity_detail->id?>">
                                                    <div class="col-lg-6 col-md-6 col-sm65-xs-12">
                                                        <input type="hidden" name="activity_data[]" value="<?=$employee_activity_detail->id?>">
                                                        <label class="sf-label">Name Of Institution</label>
                                                        <span class="rflabelsteric"><strong>*</strong></span>
                                                        <input class="form-control requiredField" name="institution_name_<?=$employee_activity_detail->id?>" id="institution_name_<?=$employee_activity_detail->id?>" value="<?=$employee_activity_detail->institution_name?>" required>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <label class="sf-label">Position Held</label>
                                                        <span class="rflabelsteric"><strong>*</strong></span>
                                                        <input type="text" class="form-control requiredField" placeholder="Particulars" name="position_held_<?=$employee_activity_detail->id?>" id="position_held_<?=$employee_activity_detail->id?>" value="<?=$employee_activity_detail->position_held?>" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right remove_area4_<?=$employee_activity_detail->id?>">
                                                    <br>
                                                    <button type="button" onclick="removeActivityDataSection('<?=$employee_activity_detail->id?>')" class="btn btn-xs btn-danger remove_area4_">Remove</button>
                                                </div>
                                            @endforeach
                                        </div>
                                        ...
                                        <script>
                                            $("#addMoreActivities").click(function(e){
                                                ...
                                                $("#insert_clone4").append('<div class="remove_area4_'+form_rows_count+' get_rows4" id=""><input type="hidden" name="activity_data[]" value="'+form_rows_count+'">' +
                                                    ...
                                                    '</div></div>' +
                                                    '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right"><br><button type="button" onclick="removeActivityDataSection('+form_rows_count+')" class="btn btn-xs btn-danger remove_area4_'+form_rows_count+'">Remove</button><div>');
                                ...
                                <div class="row" id="work_experience_area_1">
                                    @if($employee_work_experience->count() > 0)
                                                ...
                                                <table class="table table-bordered sf-table-list">
                                                    ...
                                                    @foreach($employee_work_experience->get() as $employee_work_experience_value)
                                                        <tr class="get_rows1" id="remove_area1_<?=$employee_work_experience_value->id?>"><td class="text-center"><span class="badge badge-pill badge-secondary">{{$counter4++}}</span></td>
                                                            ...
                                                            <td class="text-center">
                                                                <select class="form-control requiredField" name="position_held_<?=$employee_work_experience_value->id?>" id="position_held_<?=$employee_work_experience_value->id?>" required>
                                                                    <option value="">Select Department</option>
                                                                    @foreach($departments as $key => $y)
                                                                        <optgroup label="{{ $y->department_name}}" value="{{ $y->id}}">
                                                                            ...
                                                                            @foreach($subdepartments as $y2)
                                                                                <option @if($y2->id == 	$employee_work_experience_value->position_held ) selected @endif value="{{ $y2->id}}">{{ $y2->sub_department_name}}</option>
                                                                            @endforeach
                                                                        </optgroup>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <td class="text-center">
                                                                <select class="form-control" name="career_level_<?=$employee_work_experience_value->id?>" id="career_level_<?=$employee_work_experience_value->id?>">
                                                                    <option value="-">-</option>
                                                                    <option @if($employee_work_experience_value->career_level == 'Fresh') selected @endif value="Fresh">Fresh</option>
                                                                    <option @if($employee_work_experience_value->career_level == 'Skilled') selected @endif value="Skilled">Skilled</option>
                                                                    <option @if($employee_work_experience_value->career_level == 'Highly Skilled') selected @endif  value="Highly Skilled">Highly Skilled</option>
                                                                    <option @if($employee_work_experience_value->career_level == 'Subject Matter Experienced') selected @endif  value="Subject Matter Experienced">Subject Matter Experienced</option>
                                                                </select>
                                                            </td>
                                                            ...
                                                            <td class="text-center"><input name="last_drawn_salary_<?=$employee_work_experience_value->id?>" id="last_drawn_salary_<?=$employee_work_experience_value->id?>" type="number" class="form-control"  value="<?=$employee_work_experience_value->last_drawn_salary?>"></td>
                                                            <td class="text-center"><input name="reason_leaving_<?=$employee_work_experience_value->id?>" id="reason_leaving_<?=$employee_work_experience_value->id?>" type="text" class="form-control"  value="<?=$employee_work_experience_value->reason_leaving?>"></td>
                                                            <td class="text-center">
                                                            ...
                                                            <td class='text-center'>
                                                                ...
                                                                <button onclick='removeWorkExperienceSection("<?=$employee_work_experience_value->id?>")' type='button'class='btn btn-xs btn-danger'>Remove</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
                                        ...
                                        @if($employee_work_experience_doc->count() > 0)
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                                <a style="float: right;" onclick="showMasterTableEditModel('hdc/viewEmployeeExperienceDocuments','<?php echo $employee_detail->id.'|'.$employee_detail->emp_code;?>','View Employee Work Experience Documents','<?php echo $m; ?>')" class=" btn btn-info btn-xs">View</a>
                                            </div>
                                        @endif
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                        ...
                                        <script>
                                            $("#addMoreWorkExperience").click(function(e){
                                                ...
                                                $("#insert_clone1").append("<tr class='get_rows1' id='remove_area1_"+form_rows_count+"' ><td class='text-center'>" +
                                                    ...
                                                    "@foreach($subdepartments as $y2)<option value='{{ $y2->id}}'>{{ $y2->sub_department_name}}</option>" +
                                ...
                                <div class="row" id="reference_area_1">
                                    @if($employee_reference_data->count() > 0 )
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                            <div class="table-responsive">
                                                @foreach($employee_reference_data->get() as $employee_reference_value)
                                                    <table class="table table-bordered sf-table-list get_rows2 remove_area2_<?=$employee_reference_value->id?>" id="get_clone2">
                                                        <thead>
                                                        <th>Name<span class="rflabelsteric"><strong>*</strong></span></th><td class="text-center">
                                                            ...
                                                            <input class="form-control requiredField" name="reference_name_<?=$employee_reference_value->id?>" id="reference_name_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_name?>" required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Designation<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input class="form-control requiredField" name="reference_designation_<?=$employee_reference_value->id?>" id="reference_designation_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_designation?>" required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Organization<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input class="form-control requiredField" name="reference_organization_<?=$employee_reference_value->id?>" id="reference_organization_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_organization?>"  required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Address<span class="rflabelsteric"><strong>*</strong></span></th><td class="text-center">
                                                            <input class="form-control" name="reference_address_<?=$employee_reference_value->id?>" id="reference_address_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_address?>"  required></td>
                                                        </thead>
                                                        <thead>
                                                        <th>Country<span class="rflabelsteric"><strong>*</strong></span></th><td class="text-center">
                                                            <input class="form-control requiredField" name="reference_country_<?=$employee_reference_value->id?>" id="reference_country_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_country?>"  required></td>
                                                        </thead>
                                                        <thead>
                                                        <th>Contact Number<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center">
                                                            <input class="form-control" type="text" name="reference_contact_<?=$employee_reference_value->id?>"  id="reference_contact_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_contact?>"  required>
                                                        </td>
                                                        </thead>
                                                        <thead>
                                                        <th>Relationship<span class="rflabelsteric"><strong>*</strong></span></th>
                                                        <td class="text-center"><input class="form-control requiredField" name="reference_relationship_<?=$employee_reference_value->id?>" id="reference_relationship_<?=$employee_reference_value->id?>" value="<?=$employee_reference_value->reference_relationship?>"  required></td>
                                                        </thead>
                                                    </table>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right remove_area2_<?=$employee_reference_value->id?>">
                                                        <button type="button" onclick="removeReferenceSection('<?=$employee_reference_value->id?>')" class="btn btn-xs btn-danger remove_area2_<?=$employee_reference_value->id?>">Remove</button>
                                                    </div>
                                                @endforeach
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                            <button type="button" class="btn btn-xs btn-primary" id="addMoreReference">Add More Reference</button>
                                        </div>
                                        <script>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered sf-table-list" >
                                                    <thead>
                                                    <th class="text-center col-sm-1">S.No</th>
                                                    <th>Name<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    <th>Relation<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    <th>Percentage<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    <th>Address/Mobile No#<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    ...
                                                    @foreach($employee_kins_data->get() as $employee_kins_value)
                                                        <tr class="remove_area6_<?=$employee_kins_value->id?> get_rows9">
                                                            ...
                                                            <td class="text-center">
                                                                <input class="form-control requiredField" name="next_kin_percentage_<?=$employee_kins_value->id?>" id="next_kin_percentage_<?=$employee_kins_value->id?>" value="<?=$employee_kins_value->next_kin_percentage?>"  required>
                                                            </td>
                                                            <td class="text-center">
                                                                <input class="form-control requiredField" name="next_kin_address_<?=$employee_kins_value->id?>" id="next_kin_address_<?=$employee_kins_value->id?>" value="<?=$employee_kins_value->next_kin_address?>" required>
                                                            </td>
                                                            <td class="text-center">
                                                                <button type='button' onclick='removeKinDetailsSection("<?=$employee_kins_value->id?>")' class='btn btn-xs btn-danger remove_area9_"<?=$employee_kins_value->id?>"'>Remove</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
                                    ...
                                    @if($employee_relatives_data->count() > 0)
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 get_rows10">
                                            <div class="table-responsive">
                                                <table class="table table-bordered sf-table-list" >
                                                    <thead>
                                                    <th class="text-center col-sm-1">S.No</th><th>Name<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    <th>Position<span class="rflabelsteric"><strong>*</strong></span></th>
                                                    <th class="text-center">
                                                        <button type="button" class="btn btn-xs btn-primary" id="addMoreRelativesDetails">Add More Relatives Details</button>
                                                    </th>
                                                    </thead>
                                                    ...
                                                    @foreach($employee_relatives_data->get() as $employee_relatives_value)
                                                        <tr class="get_rows10 remove_area10_<?=$employee_relatives_value->id?>">
                                                            ...
                                                            <td class="text-center"><input class="form-control requiredField" name="relative_name_<?=$employee_relatives_value->id?>" id="relative_name_<?=$employee_relatives_value->id?>" value="<?=$employee_relatives_value->relative_name?>" required></td>
                                                            <td class="text-center"><input class="form-control requiredField" name="relative_position_<?=$employee_relatives_value->id?>"  id="relative_position_<?=$employee_relatives_value->id?>" value="<?=$employee_relatives_value->relative_position?>" required></td>
                                                            <td class="text-center">
                                                                <button type="button" onclick="removeRelativesDetailsSection('<?=$employee_relatives_value->id?>')" class="btn btn-xs btn-danger remove_area10_<?=$employee_relatives_value->id?>">Remove</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
                                        ...
                                        <script>
                                            $("#addMoreRelativesDetails").click(function(e){
                                                ...
                                                $("#insert_clone10").append('<tr class="remove_area10_'+form_rows_count+' get_rows10" id="">' +
                                                    ...
                                                    '<td class="text-center"><input class="form-control requiredField" name="relative_position_'+form_rows_count+'" value="" id="relative_position_'+form_rows_count+'" required></td>' +
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="crime_check_input_1">
                                    @if($employee_other_details->count() > 0 )
                                        @if($employee_other_details->value('crime_check') == 'Yes')
                                            ...
                                            <span class="rflabelsteric"><strong>*</strong></span>
                                            <input type="text" class="form-control requiredField" placeholder="Detail" name="crime_detail_1" id="crime_detail_1" value="<?=$employee_other_details->value('crime_detail')?>" />
                                        @endif
                                    @endif
                                </div>
                                <div class="row">&nbsp;</div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="additional_info_input_1">
                                    @if($employee_other_details->count() > 0 )
                                        @if($employee_other_details->value('additional_info_check') == 'Yes')
                                            <label class="sf-label">Detail</label><span class="rflabelsteric"><strong>*</strong></span>' +
                                            <input type="text" class="form-control requiredField" placeholder="Detail" name="additional_info_detail_1" id="additional_info_detail_1" value="<?=$employee_other_details->value('additional_info_detail')?>" />
                                        @endif
                                    @endif
                                </div>
                                <div class="row">&nbsp;</div>
                                ...
                                <div class="row" style="background-color: gainsboro">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right">
                                        <input @if($employee_gssp_documents->count() > 0) checked @endif type="checkbox" name="gssp_verification_check" id="gssp_verification_check" value="1">
                                    </div>
                                </div>
                                <div class="row">
                                    <div id="gssp_upload_area" class="col-lg-11 col-md-11 col-sm-11 col-xs-10"></div>
                                    @if($employee_gssp_documents->count() > 0)
                                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                            <a style="margin-top: 36px;" onclick="showMasterTableEditModel('hdc/viewEmployeeGsspVeriDetail','<?php echo $employee_detail->id ?>','View Employee GSSP Documents','<?php echo $m; ?>')" class=" btn btn-info btn-xs">View</a>
                                        </div>
                                    @endif
                                </div>
                                <div class="row">&nbsp;</div>
                                ...
                                <div class="row" >
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="file_upload_area" ></div>

                                    @if($employee_documents->value('documents_upload_check') == 1)
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <a style="margin-top: 36px;" onclick="showMasterTableEditModel('hdc/viewEmployeeDocuments','<?php echo $employee_detail->id;?>','View Employee Documents','<?php echo $m; ?>')" class=" btn btn-info btn-xs">View</a>
                                        </div>
                                    @endif
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"></div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"></div>
    ...
    <script>
        ...
        $('#language_check_1').click(function(){
            ...
            if($(this).is(":checked") == true)
            {
                $("#language_area_1").html('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">' +
                    ...
                    '</td><td class="text-center"><b>Good : <input type="radio" name="reading_skills_1" value="Good"></b><b>Fair : <input type="radio" name="reading_skills_1" value="Fair">' +
                    '</b><b>Poor : <input type="radio" name="reading_skills_1" value="Poor"></b></td><td class="text-center"><b>Good : <input type="radio" name="writing_skills_1" value="Good"></b>' +
                    '<b>Fair : <input type="radio" name="writing_skills_1" value="Fair"></b><b>Poor : <input type="radio" name="writing_skills_1" value="Poor"></b>' +
                    '</td><td class="text-center"><b>Good : <input type="radio" name="speaking_skills_1" value="Good"></b><b>Fair : <input type="radio" name="speaking_skills_1" value="Fair"></b>' +
        ...
        $('#health_type_check_1').click(function(){
            ...
            if($(this).is(":checked") == true)
            {
                $("#health_type_area_1").html('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">' +
                    ...
                    '<td class="text-center"><select class="form-control" name="health_type_1" id="health_type_1" required>' +
                ...
                $("#addMoreHealth").click(function(e){
                    ...
                    $("#insert_clone8").append('<tr class="remove_area8_'+form_rows_count+' get_rows8" id="">' +
                        '<td class="text-center"><span class="badge badge-pill badge-secondary">'+form_rows_count+'</td>' +
                        '<td class="text-center"><select class="form-control" name="health_type_'+form_rows_count+'" id="health_type_'+form_rows_count+'" required>'+clone_health_type+'</select></td>' +
                        '<td class="text-center"><select class="form-control" name="health_check_'+form_rows_count+'" id="health_check_'+form_rows_count+'" required>'+clone_health_check+'</select></td>' +
                        '<td class="text-center"><input type="hidden" name="health_data[]" value="'+form_rows_count+'">' +
                        '<button type="button" onclick="removeHealthDetailsSection('+form_rows_count+')" class="btn btn-xs btn-danger remove_area8_'+form_rows_count+'">Remove</button></td>' +
                        '</tr>');
        ...
        $('#work_experience_check_1').click(function(){
            ...
            if($(this).is(":checked") == true)
            {
                $("#work_experience_area_1").html(' <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="table-responsive">' +
                    ...
                    '<td id="get_clone1" class="text-center"><input type="hidden" name="work_experience_data[]" value="1"><input type="hidden" name="recordType_1" value="insert">' +
        ...
        $('#kins_check_1').click(function(){
            ...
            if($(this).is(":checked") == true)
            {
                $("#kins_area_1").html('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 get_rows9"><div class="table-responsive"> ' +
                    ...
                    '<th>Percentage<span class="rflabelsteric"><strong>*</strong></span></th>' +
                    '<th>Address/Mobile No#<span class="rflabelsteric"><strong>*</strong></span></th>' +
                    '<th> <button type="button" class="btn btn-xs btn-primary" id="addMoreKinDetails">Add More Kin Details</button></th>' +
        ...
        $("input[name='transport_check_1']").click(function() {
            ...
            if($(this).val() == 'Yes')
            {
                $("#transport_particular_area_1").html(' <label class="sf-label">Particulars</label>' +
                    '<span class="rflabelsteric"><strong>*</strong></span>' +
                    '<input type="text" class="form-control requiredField" placeholder="Particulars" name="transport_particulars_1" ' +
                    'id="transport_particulars_1" value="'+$("#hidden_transport_particulars_1").val()+'" />' +
                    '');
            }
            else
            {
        ...
        $(document).ready(function () {
            if($('#gssp_verification_check').is(":checked") == true)
            {
                $("#gssp_upload_area").html(' <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="row"> &nbsp </div><div class="table-responsive">' +
                    '<table class="table table-bordered sf-table-list"><thead><th class="text-center col-sm-1">S.No</th>' +
                    '<th class="col-sm-4 text-center">Document Type:</th>' +
                    ...
                    '<option value="">Select</option><option value="Nadra">Nadra</option><option value="Police">Police</option></select></td>' +
                    '<td class="text-center">@if($employee_gssp_documents->count() > 0)<p class="pointer" style="color: green;" onclick="gsspFile(this.id)" id="gssp_file_text">Change / Edit GSSP document</p> <input style="display: none\n;" class="form-control" type="file" name="document_file_1" id="document_file_1" > @endif</td>' +
                    '<td class="text-center">-</td></tr></tbody></table></div></div>');
        ...
        $(document).ready(function () {
            ...
            if($('#documents_upload_check').is(":checked") == true)
            {
                $("#file_upload_area").html('<label>&nbsp</label> @if($employee_documents->value('documents_upload_check') == 1)<p class="pointer" style="color: green;" onclick="documentFile(this.id)" id="document_file">Click here to change / edit Documents</p>' +
                    '<span id="media_show" style="display: none"><label>Upload File</label><input type="file" class="form-control" name="media[]" id="media" multiple></span> @endif');
            }
            else
            {
        ...
        function gsspFile(id) {
            $('#'+id).hide();
            $('#document_file_1').show();
        }
        ...
        $(document).ready(function () {
            ...
            if($('#life_time_cnic_1').is(":checked") == true)
            {
                $("#cnic_expiry_date_1").attr('disabled', 'disabled');
                $("#cnic_expiry_date_1").removeClass('requiredField');
            }
