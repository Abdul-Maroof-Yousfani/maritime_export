 ...
 <div class="well">
     <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <span class="subHeadingLabelClass">View Employee Transfer List</span>
         </div>
     </div>
     <div class="panel">
             ...
             <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="table-responsive LeavesData">
                         <table class="table table-bordered sf-table-lis table-hover" id="LeaveApplicationRequestList">
                             <thead>
                            ...
                            $transfer_employee_project = DB::table('transfer_employee_project')->where([['emr_no','=',$value->emr_no],['active','=',1]])->first();
                            ...
                            if($value->transfer_project_id != 0){
                                $employee_project = HrHelper::getMasterTableValueById($m,'employee_projects','project_name',$transfer_employee_project->employee_project_id);
                                }
                            ?>
