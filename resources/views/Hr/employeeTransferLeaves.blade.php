                ...
                <div class="dp_sdw">    
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <span class="subHeadingLabelClass">Employee Transfer Leaves</span>
                        </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <input type="button" class="btn btn-primary" id="showAttendenceReport" onclick="viewLeavesBalances()" value="Search" style="margin-top: 32px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function viewLeavesBalances(){
            ...
            if(validate == 0){
                ...
                $.ajax({
                    url: '<?php echo url('/')?>/hdc/employeeGetLeavesBalances',
                    type: "GET",
