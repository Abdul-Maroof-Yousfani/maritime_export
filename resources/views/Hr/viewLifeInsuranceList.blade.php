														...
														@foreach($LifeInsurances as $key => $y)
															<tr>
																...
																<td class="text-center">
																	...
																	@if($y->status == 2)
																		<button class="delete-modal btn btn-xs btn-primary" onclick="repostMasterTableRecords('<?php echo $y->id ?>','life_insurance')">
																			<span class="glyphicon glyphicon-refresh"></span>
																		</button>

																	@else
																		<button class="delete-modal btn btn-xs btn-danger" onclick="deleteRowMasterTable('<?php echo $y->life_insurance_name ?>','<?php echo $y->id ?>','life_insurance')">
