...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">View Scrap Sales List</span>
                                        <div class="row" style="margin-top: 2%">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <input type="button" value="Fetch Scrap Sale"
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table id="table" class="table table-bordered">
                                                                <thead>
                                                                    ...
                                                                    <th class="text-center">Scrap Sale No </th>
                                                                    <th class="text-center">Scrap Declration No </th>
                                                                    <th class="text-center">Scrap Sale Date </th>
    ...
    <script>
        ...
        function FetchPOList() {
            ...
            $.ajax({
                url: '{{ url('purchase/scrap_sales') }}?pageType=&&parentCode=244&&m='+{{$m}}+'#Garibsons',
                method: 'GET',
                data: {
                    from_date: from_date,
                    to_date: to_date,
        ...
        function delete_scrap(id) {
            ...
            if(confirm('Are u sure you want to delete this?')){
                $.ajax({
                    url: '{{ url('purchase/delete_scrap_sale') }}',
                    data: {
                        id: id
                    },
                    type: 'GET',
