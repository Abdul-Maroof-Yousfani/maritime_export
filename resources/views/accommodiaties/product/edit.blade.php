                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Edit Verity</span>
                                    </div>
                                </div>
                                                    ...
                                                    <form action="{{ route('product.update', $product->id) }}" method="post"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <select required autofocus name="parent_id" id="parent_id"
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <select required autofocus name="product_type" id="product_type"
                                                                    class="form-control requiredField select2" onchange="hideShowHddenField()">
                                                                    <option value="">Select Product Type</option>
                                                                    <option {{ $product->product_type == '1' ? 'selected' : '' }} value="1">Finish Goods</option>
                                                                    <option {{ $product->product_type == '2' ? 'selected' : '' }} value="2">Row Material</option>
                                                                </select>
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label>Variety Type:</label>
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <select required name="variety_type" id="variety_type"
                                                                    class="form-control requiredField select2">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                ...
                                                                <select style="width: 100%" name="crop_based"
                                                                    ...
                                                                    <option value="1"
                                                                        {{ $product->crop_based  == 1 ? 'selected' : '' }}>YES
                                                                    </option>
                                                                    <option value="0"
                                                                        {{ $product->crop_based  == 0 ? 'selected' : '' }}>NO
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" id="show1">
                                                                <label>QC Type :</label>
                                                                <span class="rflabelsteric"><strong>*</strong></span>
                                                                <select name="qc_id[]" id="qc_id[]"
                                                                    class="form-control requiredField select2" multiple>
                                                                    <option value="">Select Quality</option>
                                                                    @php
                                                                        $qc_ids = $product->qc_id ? json_decode($product->qc_id, true) : [];
                                                                    @endphp
                                                                    @foreach ($qualities as $key => $i)
                                                                        <option value="{{ $i->id }}"
                                                                            {{ in_array($i->id, $qc_ids) ? 'selected' : '' }}>
                                                                            {{ $i->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
