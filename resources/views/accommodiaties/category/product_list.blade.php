                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Sub Variety List</span>
                                    </div>
                                </div>
                                                                ...
                                                                <tbody id="viewSlabList" class="text-center">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> 
                                                                            ...
                                                                            href="{{ url('commodities/ListProductEdit/' . $product->id . '?pageType=&&parentCode=215&&m='.session('run_company').'#Garibsons') }}">Edit</a>         --}}
                                                                        

                                                                            <a class="btn btn-xs btn-info" href="{{ route('product.sub.variety.edit',$product->id) }}">Edit</a>  
                                                                           
                                                                           
                                                                            <button class="delete-modal btn btn-xs btn-danger"
                                                                            onClick="delete_ar({{ $product->id }})">Delete</button>   </td>
