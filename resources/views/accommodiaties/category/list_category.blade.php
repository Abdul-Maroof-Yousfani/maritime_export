                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Category List</span>
                                    </div>
                                </div>
                                                                ...
                                                                <tbody id="viewSlabList" class="text-center">
                                                                    @foreach ($categories as $key => $category)
                                                                        <tr>
                                                                            ...
                                                                            <td>   <a class="btn btn-xs btn-info" href="{{ route('category.edit', $category->id) }}">Edit</a>  
                                                                           <button class="delete-modal btn btn-xs btn-danger"
                                                                                onClick="delete_ar({{ $category->id }})">Delete</button>   </td>
