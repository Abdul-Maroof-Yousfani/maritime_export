                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="well">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="subHeadingLabelClass">Add Item</span>
                                    </div>
                                </div>
                                                                    ...
                                                                    <table class="table table-bordered" id="parameterTable">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="text" name="damage" class="form-control"></td>
                                                                                <td><input type="text" name="chalky" class="form-control"></td>
                                                                                <td><input type="text" name="broken" class="form-control"></td>
                                                                                <td><input type="text" name="o_v" class="form-control"></td>
                                                                                <td><input type="text" name="chobba" class="form-control"></td>
                                                                                <td><input type="text" name="look" class="form-control"></td>
