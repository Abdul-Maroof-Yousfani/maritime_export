        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered sf-table-list"
                ...
                <tbody >
                    ...
                    <tr>
                        <td>{{ ($value->demand_date)? date_format(new DateTime($value->demand_date),"d-M-Y") : '-'}}</td>
                        ...
                        <td>
                            <?php echo $uom =  CommonHelper::get_uom_by_uom_id($value->uom); ?>
                        </td>
                        ...
                        <td>{{CommonHelper::getComparativeNoByPrId($value->demand_id)->group_number ?? ''}}</td>  {{-- $value->group_number --}} 
