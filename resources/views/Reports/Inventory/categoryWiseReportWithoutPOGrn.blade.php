    ...
    <div class="">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dp_sdw">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <span class="subHeadingLabelClass">Category Wise Report Without PO GRN</span>
                        </div>
        ...
        <script>
            ...
            function stockReportItemWise() {
                ...
                $('#filterBookDayList').html(
                    '<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div>');
                $.ajax({
                    url: '<?php echo url('/'); ?>/reports/categoryWiseReportWithoutPOGrnAjax',
                    method: 'GET',
                    data: {
