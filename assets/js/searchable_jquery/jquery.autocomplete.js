...
(function($) {
    ...
    var makeUrl = function(url, params) {
     ...
     var actual_url=current_id.split('_');


      var   category_id=$('#category_'+actual_url[1]).val();
      var   sub_category=$('#subcategory_'+actual_url[1]).val();
        url='/pdc/search/'+category_id+'/'+sub_category;
