...
function filterVoucherList(){
    ...
    if(filterType == 1){
        ...
        $.getJSON(url, {fromDate: fromDate, toDate: toDate, m: m,department_id:department_id,departments:departments,selectVoucherStatus:selectVoucherStatus,p_type:p_type, pr_no:pr_no,company_location_id:company_location_id,selectSubDepartmentId:selectSubDepartmentId,selectSubDepartment:selectSubDepartment }, function (result) {
...
$("#department_id").change(function() {
    var selectSubDepartmentTwo = this.value;
